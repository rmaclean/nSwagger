...
// This file was last generated at: 2016-03-15T14:15:20.8481795Z
namespace nSwagger {
    export module Portal {
        ...
        export interface StudentCalendarInfomationRequest {
            End: string;
            Start: string;
        }
        ...
        export interface CollectionResponseDroppedOutResponse {
            Items: Array<DroppedOutResponse>;
            Next: string;
            Previous: string;
            TotalCount: number;
        }
        ...
        export interface AddStudentToExamRequest {
            ExamId: number;
            StudentId: string;
        }

        export interface CollectionResponseExamResponse {
            Items: Array<ExamResponse>;
            Next: string;
            Previous: string;
            TotalCount: number;
        }
        ...
        export interface CollectionResponseFurtherEmploymentResponse {
            Items: Array<FurtherEmploymentResponse>;
            Next: string;
            Previous: string;
            TotalCount: number;
        }
        ...
        export interface CollectionResponseHostEmployerResponse {
            Items: Array<HostEmployerResponse>;
            Next: string;
            Previous: string;
            TotalCount: number;
        }
        ...
        export interface CollectionResponseClaimedRewardsResponse {
            Items: Array<ClaimedRewardsResponse>;
            Next: string;
            Previous: string;
            TotalCount: number;
        }
        ...
        export interface CollectionResponseTrainingProviderResponse {
            Items: Array<TrainingProviderResponse>;
            Next: string;
            Previous: string;
            TotalCount: number;
        }
        ...
        export interface Calendar_PostStudentCalendarInformationRequest {
            request: StudentCalendarInfomationRequest;
            id: string;
        }
        ...
        export interface Courses_PostAddStudentsToCourseRequest {
            request: AddStudentToCourseRequest;
        }
        ...
        export interface Exam_PostAddStudentToExamRequest {
            request: AddStudentToExamRequest;
        }
        ...
        export interface Reward_PostAssociateStudentToRewardRequest {
            studentId: string;
            rewardsId: number;
        }
        ...
        export interface Reward_GetRewardsRequest {
            id: number;
        }
        ...
        export interface ShareCalendar_GetShareCalendarRequest {
            id: string;
            startDate: string;
            skip?: number;
            top?: number;
        ...
        export interface Students_PostStudentInformationRequest {
            id: string;
        ...
        export interface TrainingProviders_PostAssociateStudentToTrainingProviderRequest {
            studentId: string;
            trainingProviderId: number;
        }
        ...
        export interface TrainingProviders_PutEnableTrainingProviderRequest {
            id: number;
        }
        ...
        export interface API {
            ...
            Admins_PutUpdateAdmin(parameters: Admins_PutUpdateAdminRequest): PromiseLike<void>;
            ...
            Calendar_PostStudentCalendarInformation(parameters: Calendar_PostStudentCalendarInformationRequest): PromiseLike<Array<CalendarResponse>>;
            ...
            Courses_PostAddStudentsToCourse(parameters: Courses_PostAddStudentsToCourseRequest): PromiseLike<void>;
            ...
            Exam_PostAddStudentToExam(parameters: Exam_PostAddStudentToExamRequest): PromiseLike<void>;
            ...
            HostEmployer_PutHostEmployer(parameters: HostEmployer_PutHostEmployerRequest): PromiseLike<void>;
            ...
            Reward_GetStudentReward(parameters: Reward_GetStudentRewardRequest): PromiseLike<CollectionResponseClaimedRewardsResponse>;
            Reward_PostAssociateStudentToReward(parameters: Reward_PostAssociateStudentToRewardRequest): PromiseLike<void>;
            ...
            Reward_GetRewards(parameters: Reward_GetRewardsRequest): PromiseLike<RewardResponse>;
            ...
            Reward_GetRewards(parameters?: Reward_GetRewardsRequest): PromiseLike<CollectionResponseRewardResponse>;
            Reward_PostAddStudentReward(parameters: Reward_PostAddStudentRewardRequest): PromiseLike<RewardResponse>;
            ShareCalendar_GetShareCalendar(parameters: ShareCalendar_GetShareCalendarRequest): PromiseLike<CollectionResponseCalendarResponse>;
            ...
            Students_PostStudentInformation(parameters: Students_PostStudentInformationRequest): PromiseLike<StudentResponse>;
            ...
            TrainingProviders_PostAssociateStudentToTrainingProvider(parameters: TrainingProviders_PostAssociateStudentToTrainingProviderRequest): PromiseLike<void>;
            ...
            TrainingProviders_PutEnableTrainingProvider(parameters: TrainingProviders_PutEnableTrainingProviderRequest): PromiseLike<void>;
            ...
            TrainingProviders_PutTrainingProviders(parameters: TrainingProviders_PutTrainingProvidersRequest): PromiseLike<void>;
