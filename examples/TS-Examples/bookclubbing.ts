...
// This file was last generated at: 2016-03-15T14:15:05.4020207Z
namespace nSwagger {
    export module BookClubbingAPI {
        ...
        export class BookItem {
            ...
            Description: string;
            Genres: Array<GenreResponseItem>;
            GoodReadsId: string;
            GutenburgId: string;
            Id: string;
            ImageUrl: string;
        ...
        export interface CollectionResponseClubGetMemberResponse {
            Items: Array<ClubGetMemberResponse>;
            Next: string;
            Previous: string;
            TotalCount: number;
        }
        ...
        export interface CollectionResponseReservationResponseItem {
            Items: Array<ReservationResponseItem>;
            Next: string;
            Previous: string;
            TotalCount: number;
        }
        ...
        export interface CollectionResponseClubGetUserResponse {
            Items: Array<ClubGetUserResponse>;
            Next: string;
            Previous: string;
            TotalCount: number;
        }
        ...
        export interface CollectionResponseUserSearchResponse {
            Items: Array<UserSearchResponse>;
            Next: string;
            Previous: string;
            TotalCount: number;
        }
        ...
        export interface API {
            ...
            Book_GetTop10(parameters?: Book_GetTop10Request): PromiseLike<Array<Top10ResponseItem>>;
            Book_Post(parameters: Book_PostRequest): PromiseLike<BookItem>;
            Book_Get(parameters?: Book_GetRequest): PromiseLike<Array<BookItem>>;
            ...
            Club_GetTop10(parameters: Club_GetTop10Request): PromiseLike<Array<Top10ResponseItem>>;
            ...
            Genres_Get(parameters?: Genres_GetRequest): PromiseLike<Array<GenreResponseItem>>;
            ...
            Trending_GetClubTrending(parameters: Trending_GetClubTrendingRequest): PromiseLike<Array<BookItem>>;
            Trending_GetTrending(parameters?: Trending_GetTrendingRequest): PromiseLike<Array<BookItem>>;
            ...
            User_GetMyReservations(parameters?: User_GetMyReservationsRequest): PromiseLike<Array<ReservationResponseItem>>;
