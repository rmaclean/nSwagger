...
namespace nSwagger
{
    ...
    public class BookClubbingAPI
    {
        ...
        public BookClubbingAPI(string url = null)
        {
        ...
        {
            {
                var response = await HTTP.HTTP.PostAsync(new Uri(url + "/api/registrationpin", UriKind.Absolute), new HTTPOptions(TimeSpan.FromSeconds(30)), new StringContent(JsonConvert.SerializeObject(request)));
                if (response == null)
                {
        ...
        {
            {
                var response = await HTTP.HTTP.PostAsync(new Uri(url + "/api/Auth", UriKind.Absolute), new HTTPOptions(TimeSpan.FromSeconds(30)), new StringContent(JsonConvert.SerializeObject(request)));
                if (response == null)
                {
        ...
        {
            {
                var response = await HTTP.HTTP.GetAsync(new Uri(url + "/api/book/admin", UriKind.Absolute), new HTTPOptions(TimeSpan.FromSeconds(30)), token: oauthToken);
                if (response == null)
                {
        ...
        {
            {
                var response = await HTTP.HTTP.GetAsync(new Uri(url + "/api/book/" + id + "/ratings", UriKind.Absolute), new HTTPOptions(TimeSpan.FromSeconds(30)), token: oauthToken);
                if (response == null)
                {
        ...
        {
            {
                var response = await HTTP.HTTP.GetAsync(new Uri(url + "/api/book/top10", UriKind.Absolute), new HTTPOptions(TimeSpan.FromSeconds(30)), token: oauthToken);
                if (response == null)
                {
        ...
        {
            {
                var response = await HTTP.HTTP.PostAsync(new Uri(url + "/api/book/add", UriKind.Absolute), new HTTPOptions(TimeSpan.FromSeconds(30)), new StringContent(JsonConvert.SerializeObject(request)), token: oauthToken);
                if (response == null)
                {
                    return new APIResponse<BookItem>(false);
                }
        ...
        {
            {
                var response = await HTTP.HTTP.GetAsync(new Uri(url + "/api/Book", UriKind.Absolute), new HTTPOptions(TimeSpan.FromSeconds(30)), token: oauthToken);
                if (response == null)
                {
                    return new APIResponse<BookItem[]>(false);
                }
        ...
        {
            {
                var response = await HTTP.HTTP.PostAsync(new Uri(url + "/api/Book", UriKind.Absolute), new HTTPOptions(TimeSpan.FromSeconds(30)), new StringContent(JsonConvert.SerializeObject(request)), token: oauthToken);
                if (response == null)
                {
                    return new APIResponse<string>(false);
                }
        ...
        {
            {
                var response = await HTTP.HTTP.PutAsync(new Uri(url + "/api/Book/" + id + "", UriKind.Absolute), new HTTPOptions(TimeSpan.FromSeconds(30)), new StringContent(JsonConvert.SerializeObject(request)), token: oauthToken);
                if (response == null)
                {
                    return new APIResponse<string>(false);
                }
        ...
        {
            {
                var response = await HTTP.HTTP.DeleteAsync(new Uri(url + "/api/book/read/" + id + "", UriKind.Absolute), new HTTPOptions(TimeSpan.FromSeconds(30)), token: oauthToken);
                if (response == null)
                {
                    return new APIResponse<object>(false);
                }
        ...
        {
            {
                var response = await HTTP.HTTP.GetAsync(new Uri(url + "/api/book/read/" + id + "", UriKind.Absolute), new HTTPOptions(TimeSpan.FromSeconds(30)), token: oauthToken);
                if (response == null)
                {
        ...
        {
            {
                var response = await HTTP.HTTP.GetAsync(new Uri(url + "/api/book/read", UriKind.Absolute), new HTTPOptions(TimeSpan.FromSeconds(30)), token: oauthToken);
                if (response == null)
                {
        ...
        {
            {
                var response = await HTTP.HTTP.PostAsync(new Uri(url + "/api/book/" + id + "/read", UriKind.Absolute), new HTTPOptions(TimeSpan.FromSeconds(30)), new StringContent(JsonConvert.SerializeObject(location)), token: oauthToken);
                if (response == null)
                {
                    return new APIResponse<object>(false);
                }
        ...
        {
            {
                var response = await HTTP.HTTP.GetAsync(new Uri(url + "/api/club/" + id + "/members", UriKind.Absolute), new HTTPOptions(TimeSpan.FromSeconds(30)), token: oauthToken);
                if (response == null)
                {
        ...
        {
            {
                var response = await HTTP.HTTP.GetAsync(new Uri(url + "/api/club/" + id + "/book/top10", UriKind.Absolute), new HTTPOptions(TimeSpan.FromSeconds(30)), token: oauthToken);
                if (response == null)
                {
                    return new APIResponse<Top10ResponseItem[]>(false);
                }
        ...
        {
            {
                var response = await HTTP.HTTP.PostAsync(new Uri(url + "/api/club/" + id + "/changeRole", UriKind.Absolute), new HTTPOptions(TimeSpan.FromSeconds(30)), new StringContent(JsonConvert.SerializeObject(changeRoleRequest)), token: oauthToken);
                if (response == null)
                {
                    return new APIResponse<object>(false);
                }
        ...
        {
            {
                var response = await HTTP.HTTP.PostAsync(new Uri(url + "/api/club/" + id + "/deleteUser/" + userId + "", UriKind.Absolute), new HTTPOptions(TimeSpan.FromSeconds(30)), token: oauthToken);
                if (response == null)
                {
                    return new APIResponse<object>(false);
                }
        ...
        {
            {
                var response = await HTTP.HTTP.PostAsync(new Uri(url + "/api/club/search", UriKind.Absolute), new HTTPOptions(TimeSpan.FromSeconds(30)), new StringContent(JsonConvert.SerializeObject(request)), token: oauthToken);
                if (response == null)
                {
        ...
        {
            {
                var response = await HTTP.HTTP.DeleteAsync(new Uri(url + "/api/Club/" + id + "", UriKind.Absolute), new HTTPOptions(TimeSpan.FromSeconds(30)), token: oauthToken);
                if (response == null)
                {
                    return new APIResponse<object>(false);
                }
        ...
        {
            {
                var response = await HTTP.HTTP.GetAsync(new Uri(url + "/api/Club/" + id + "", UriKind.Absolute), new HTTPOptions(TimeSpan.FromSeconds(30)), token: oauthToken);
                if (response == null)
                {
        ...
        {
            {
                var response = await HTTP.HTTP.PutAsync(new Uri(url + "/api/Club/" + id + "", UriKind.Absolute), new HTTPOptions(TimeSpan.FromSeconds(30)), new StringContent(JsonConvert.SerializeObject(request)), token: oauthToken);
                if (response == null)
                {
                    return new APIResponse<object>(false);
                }
        ...
        {
            {
                var response = await HTTP.HTTP.PostAsync(new Uri(url + "/api/Club", UriKind.Absolute), new HTTPOptions(TimeSpan.FromSeconds(30)), new StringContent(JsonConvert.SerializeObject(request)), token: oauthToken);
                if (response == null)
                {
                    return new APIResponse<string>(false);
                }
        ...
        {
            {
                var response = await HTTP.HTTP.DeleteAsync(new Uri(url + "/api/club/" + id + "/invite/" + inviteid + "", UriKind.Absolute), new HTTPOptions(TimeSpan.FromSeconds(30)), token: oauthToken);
                if (response == null)
                {
                    return new APIResponse<object>(false);
                }
        ...
        {
            {
                var response = await HTTP.HTTP.GetAsync(new Uri(url + "/api/club/" + id + "/invite", UriKind.Absolute), new HTTPOptions(TimeSpan.FromSeconds(30)), token: oauthToken);
                if (response == null)
                {
        ...
        {
            {
                var response = await HTTP.HTTP.PostAsync(new Uri(url + "/api/club/" + id + "/invite", UriKind.Absolute), new HTTPOptions(TimeSpan.FromSeconds(30)), new StringContent(JsonConvert.SerializeObject(request)), token: oauthToken);
                if (response == null)
                {
                    return new APIResponse<object>(false);
                }
        ...
        {
            {
                var response = await HTTP.HTTP.DeleteAsync(new Uri(url + "/api/ClubJoin/" + id + "", UriKind.Absolute), new HTTPOptions(TimeSpan.FromSeconds(30)), token: oauthToken);
                if (response == null)
                {
                    return new APIResponse<object>(false);
                }
        ...
        {
            {
                var response = await HTTP.HTTP.PostAsync(new Uri(url + "/api/ClubJoin", UriKind.Absolute), new HTTPOptions(TimeSpan.FromSeconds(30)), new StringContent(JsonConvert.SerializeObject(request)), token: oauthToken);
                if (response == null)
                {
                    return new APIResponse<object>(false);
                }
        ...
        {
            {
                var response = await HTTP.HTTP.GetAsync(new Uri(url + "/api/club/" + clubId + "/member/" + memberId + "", UriKind.Absolute), new HTTPOptions(TimeSpan.FromSeconds(30)), token: oauthToken);
                if (response == null)
                {
        ...
        {
            {
                var response = await HTTP.HTTP.DeleteAsync(new Uri(url + "/api/club/" + id + "/event/" + eventid + "", UriKind.Absolute), new HTTPOptions(TimeSpan.FromSeconds(30)), token: oauthToken);
                if (response == null)
                {
                    return new APIResponse<object>(false);
                }
        ...
        {
            {
                var response = await HTTP.HTTP.GetAsync(new Uri(url + "/api/club/" + id + "/event/" + eventid + "", UriKind.Absolute), new HTTPOptions(TimeSpan.FromSeconds(30)), token: oauthToken);
                if (response == null)
                {
        ...
        {
            {
                var response = await HTTP.HTTP.PutAsync(new Uri(url + "/api/club/" + id + "/event/" + eventid + "", UriKind.Absolute), new HTTPOptions(TimeSpan.FromSeconds(30)), new StringContent(JsonConvert.SerializeObject(request)), token: oauthToken);
                if (response == null)
                {
                    return new APIResponse<object>(false);
                }
        ...
        {
            {
                var response = await HTTP.HTTP.GetAsync(new Uri(url + "/api/club/" + id + "/event", UriKind.Absolute), new HTTPOptions(TimeSpan.FromSeconds(30)), token: oauthToken);
                if (response == null)
                {
        ...
        {
            {
                var response = await HTTP.HTTP.PostAsync(new Uri(url + "/api/club/" + id + "/event", UriKind.Absolute), new HTTPOptions(TimeSpan.FromSeconds(30)), new StringContent(JsonConvert.SerializeObject(request)), token: oauthToken);
                if (response == null)
                {
                    return new APIResponse<object>(false);
                }
        ...
        {
            {
                var response = await HTTP.HTTP.PostAsync(new Uri(url + "/api/club/" + id + "/event/" + eventid + "/invite/" + userId + "", UriKind.Absolute), new HTTPOptions(TimeSpan.FromSeconds(30)), token: oauthToken);
                if (response == null)
                {
                    return new APIResponse<object>(false);
                }
        ...
        {
            {
                var response = await HTTP.HTTP.PostAsync(new Uri(url + "/api/ForgotPassword", UriKind.Absolute), new HTTPOptions(TimeSpan.FromSeconds(30)), new StringContent(JsonConvert.SerializeObject(request)));
                if (response == null)
                {
                    return new APIResponse<object>(false);
                }
        ...
        {
            {
                var response = await HTTP.HTTP.DeleteAsync(new Uri(url + "/api/genres/" + id + "/alias/" + aliasId + "", UriKind.Absolute), new HTTPOptions(TimeSpan.FromSeconds(30)), token: oauthToken);
                if (response == null)
                {
                    return new APIResponse<object>(false);
                }
        ...
        {
            {
                var response = await HTTP.HTTP.DeleteAsync(new Uri(url + "/api/genres/" + id + "/book/" + bookId + "", UriKind.Absolute), new HTTPOptions(TimeSpan.FromSeconds(30)), token: oauthToken);
                if (response == null)
                {
        ...
        {
            {
                var response = await HTTP.HTTP.PostAsync(new Uri(url + "/api/genres/" + id + "/book/" + bookId + "", UriKind.Absolute), new HTTPOptions(TimeSpan.FromSeconds(30)), token: oauthToken);
                if (response == null)
                {
                    return new APIResponse<int>(false);
                }
        ...
        {
            {
                var response = await HTTP.HTTP.PostAsync(new Uri(url + "/api/genres/" + id + "/alias", UriKind.Absolute), new HTTPOptions(TimeSpan.FromSeconds(30)), new StringContent(JsonConvert.SerializeObject(request)), token: oauthToken);
                if (response == null)
                {
                    return new APIResponse<int>(false);
                }
        ...
        {
            {
                var response = await HTTP.HTTP.DeleteAsync(new Uri(url + "/api/Genres/" + id + "", UriKind.Absolute), new HTTPOptions(TimeSpan.FromSeconds(30)), token: oauthToken);
                if (response == null)
                {
                    return new APIResponse<object>(false);
                }
        ...
        {
            {
                var response = await HTTP.HTTP.PutAsync(new Uri(url + "/api/Genres/" + id + "", UriKind.Absolute), new HTTPOptions(TimeSpan.FromSeconds(30)), new StringContent(JsonConvert.SerializeObject(request)), token: oauthToken);
                if (response == null)
                {
                    return new APIResponse<object>(false);
                }
        ...
        {
            {
                var response = await HTTP.HTTP.GetAsync(new Uri(url + "/api/Genres", UriKind.Absolute), new HTTPOptions(TimeSpan.FromSeconds(30)), token: oauthToken);
                if (response == null)
                {
        ...
        {
            {
                var response = await HTTP.HTTP.PostAsync(new Uri(url + "/api/Genres", UriKind.Absolute), new HTTPOptions(TimeSpan.FromSeconds(30)), new StringContent(JsonConvert.SerializeObject(request)), token: oauthToken);
                if (response == null)
                {
                    return new APIResponse<int>(false);
                }
        ...
        {
            {
                var response = await HTTP.HTTP.GetAsync(new Uri(url + "/api/Health", UriKind.Absolute), new HTTPOptions(TimeSpan.FromSeconds(30)));
                if (response == null)
                {
        ...
        {
            {
                var response = await HTTP.HTTP.PostAsync(new Uri(url + "/api/Logout", UriKind.Absolute), new HTTPOptions(TimeSpan.FromSeconds(30)), token: oauthToken);
                if (response == null)
                {
                    return new APIResponse<object>(false);
                }
        ...
        {
            {
                var response = await HTTP.HTTP.PostAsync(new Uri(url + "/api/OAuth", UriKind.Absolute), new HTTPOptions(TimeSpan.FromSeconds(30)), new StringContent(JsonConvert.SerializeObject(request)));
                if (response == null)
                {
                    return new APIResponse<object>(false);
                }
        ...
        {
            {
                var response = await HTTP.HTTP.GetAsync(new Uri(url + "/api/Quote", UriKind.Absolute), new HTTPOptions(TimeSpan.FromSeconds(30)), token: oauthToken);
                if (response == null)
                {
                    return new APIResponse<string>(false);
                }
        ...
        {
            {
                var response = await HTTP.HTTP.DeleteAsync(new Uri(url + "/api/Rating/" + id + "", UriKind.Absolute), new HTTPOptions(TimeSpan.FromSeconds(30)), token: oauthToken);
                if (response == null)
                {
                    return new APIResponse<object>(false);
                }
        ...
        {
            {
                var response = await HTTP.HTTP.PostAsync(new Uri(url + "/api/Rating", UriKind.Absolute), new HTTPOptions(TimeSpan.FromSeconds(30)), new StringContent(JsonConvert.SerializeObject(request)), token: oauthToken);
                if (response == null)
                {
                    return new APIResponse<object>(false);
                }
        ...
        {
            {
                var response = await HTTP.HTTP.PutAsync(new Uri(url + "/api/Rating", UriKind.Absolute), new HTTPOptions(TimeSpan.FromSeconds(30)), new StringContent(JsonConvert.SerializeObject(request)), token: oauthToken);
                if (response == null)
                {
                    return new APIResponse<object>(false);
                }
        ...
        {
            {
                var response = await HTTP.HTTP.PostAsync(new Uri(url + "/api/RegistrationConfirm", UriKind.Absolute), new HTTPOptions(TimeSpan.FromSeconds(30)), new StringContent(JsonConvert.SerializeObject(request)));
                if (response == null)
                {
                    return new APIResponse<object>(false);
                }
        ...
        {
            {
                var response = await HTTP.HTTP.DeleteAsync(new Uri(url + "/api/Reserve/" + id + "", UriKind.Absolute), new HTTPOptions(TimeSpan.FromSeconds(30)), token: oauthToken);
                if (response == null)
                {
                    return new APIResponse<object>(false);
                }
        ...
        {
            {
                var response = await HTTP.HTTP.GetAsync(new Uri(url + "/api/Reserve/" + id + "", UriKind.Absolute), new HTTPOptions(TimeSpan.FromSeconds(30)), token: oauthToken);
                if (response == null)
                {
        ...
        {
            {
                var response = await HTTP.HTTP.PostAsync(new Uri(url + "/api/Reserve", UriKind.Absolute), new HTTPOptions(TimeSpan.FromSeconds(30)), new StringContent(JsonConvert.SerializeObject(request)), token: oauthToken);
                if (response == null)
                {
                    return new APIResponse<object>(false);
                }
        ...
        {
            {
                var response = await HTTP.HTTP.DeleteAsync(new Uri(url + "/api/ReservedName/" + id + "", UriKind.Absolute), new HTTPOptions(TimeSpan.FromSeconds(30)), token: oauthToken);
                if (response == null)
                {
                    return new APIResponse<object>(false);
                }
        ...
        {
            {
                var response = await HTTP.HTTP.GetAsync(new Uri(url + "/api/ReservedName/" + id + "", UriKind.Absolute), new HTTPOptions(TimeSpan.FromSeconds(30)), token: oauthToken);
                if (response == null)
                {
                    return new APIResponse<string>(false);
                }
        ...
        {
            {
                var response = await HTTP.HTTP.PutAsync(new Uri(url + "/api/ReservedName/" + id + "", UriKind.Absolute), new HTTPOptions(TimeSpan.FromSeconds(30)), token: oauthToken);
                if (response == null)
                {
                    return new APIResponse<object>(false);
                }
        ...
        {
            {
                var response = await HTTP.HTTP.GetAsync(new Uri(url + "/api/ReservedName", UriKind.Absolute), new HTTPOptions(TimeSpan.FromSeconds(30)), token: oauthToken);
                if (response == null)
                {
        ...
        {
            {
                var response = await HTTP.HTTP.PostAsync(new Uri(url + "/api/ReservedName", UriKind.Absolute), new HTTPOptions(TimeSpan.FromSeconds(30)), token: oauthToken);
                if (response == null)
                {
                    return new APIResponse<object>(false);
                }
        ...
        {
            {
                var response = await HTTP.HTTP.PostAsync(new Uri(url + "/api/ResetPassword", UriKind.Absolute), new HTTPOptions(TimeSpan.FromSeconds(30)), new StringContent(JsonConvert.SerializeObject(request)));
                if (response == null)
                {
                    return new APIResponse<object>(false);
                }
        ...
        {
            {
                var response = await HTTP.HTTP.PostAsync(new Uri(url + "/api/club/" + id + "/resource/" + resourceId + "/checkin", UriKind.Absolute), new HTTPOptions(TimeSpan.FromSeconds(30)), token: oauthToken);
                if (response == null)
                {
                    return new APIResponse<object>(false);
                }
        ...
        {
            {
                var response = await HTTP.HTTP.DeleteAsync(new Uri(url + "/api/club/" + id + "/resource/" + resourceId + "", UriKind.Absolute), new HTTPOptions(TimeSpan.FromSeconds(30)), token: oauthToken);
                if (response == null)
                {
                    return new APIResponse<object>(false);
                }
        ...
        {
            {
                var response = await HTTP.HTTP.GetAsync(new Uri(url + "/api/club/" + id + "/resource/" + resourceId + "", UriKind.Absolute), new HTTPOptions(TimeSpan.FromSeconds(30)), token: oauthToken);
                if (response == null)
                {
        ...
        {
            {
                var response = await HTTP.HTTP.PostAsync(new Uri(url + "/api/club/" + id + "/resource/" + resourceId + "", UriKind.Absolute), new HTTPOptions(TimeSpan.FromSeconds(30)), token: oauthToken);
                if (response == null)
                {
                    return new APIResponse<object>(false);
                }
        ...
        {
            {
                var response = await HTTP.HTTP.DeleteAsync(new Uri(url + "/api/user/resource/" + resourceId + "", UriKind.Absolute), new HTTPOptions(TimeSpan.FromSeconds(30)), token: oauthToken);
                if (response == null)
                {
                    return new APIResponse<object>(false);
                }
        ...
        {
            {
                var response = await HTTP.HTTP.GetAsync(new Uri(url + "/api/club/" + id + "/resource", UriKind.Absolute), new HTTPOptions(TimeSpan.FromSeconds(30)), token: oauthToken);
                if (response == null)
                {
        ...
        {
            {
                var response = await HTTP.HTTP.GetAsync(new Uri(url + "/api/resource/" + resourceId + "", UriKind.Absolute), new HTTPOptions(TimeSpan.FromSeconds(30)), token: oauthToken);
                if (response == null)
                {
                    return new APIResponse<ResourceItem>(false);
                }
        ...
        {
            {
                var response = await HTTP.HTTP.PostAsync(new Uri(url + "/api/club/" + id + "/resource/" + resourceId + "/checkout", UriKind.Absolute), new HTTPOptions(TimeSpan.FromSeconds(30)), token: oauthToken);
                if (response == null)
                {
                    return new APIResponse<object>(false);
                }
        ...
        {
            {
                var response = await HTTP.HTTP.GetAsync(new Uri(url + "/api/RSVP/" + id + "", UriKind.Absolute), new HTTPOptions(TimeSpan.FromSeconds(30)), token: oauthToken);
                if (response == null)
                {
        ...
        {
            {
                var response = await HTTP.HTTP.PostAsync(new Uri(url + "/api/RSVP", UriKind.Absolute), new HTTPOptions(TimeSpan.FromSeconds(30)), new StringContent(JsonConvert.SerializeObject(request)), token: oauthToken);
                if (response == null)
                {
                    return new APIResponse<object>(false);
                }
        ...
        {
            {
                var response = await HTTP.HTTP.DeleteAsync(new Uri(url + "/api/system/quote", UriKind.Absolute), new HTTPOptions(TimeSpan.FromSeconds(30)), token: oauthToken);
                if (response == null)
                {
                    return new APIResponse<object>(false);
                }
        ...
        {
            {
                var response = await HTTP.HTTP.GetAsync(new Uri(url + "/api/system/quote", UriKind.Absolute), new HTTPOptions(TimeSpan.FromSeconds(30)), token: oauthToken);
                if (response == null)
                {
        ...
        {
            {
                var response = await HTTP.HTTP.PostAsync(new Uri(url + "/api/system/quote", UriKind.Absolute), new HTTPOptions(TimeSpan.FromSeconds(30)), token: oauthToken);
                if (response == null)
                {
                    return new APIResponse<object>(false);
                }
        ...
        {
            {
                var response = await HTTP.HTTP.GetAsync(new Uri(url + "/api/system", UriKind.Absolute), new HTTPOptions(TimeSpan.FromSeconds(30)), token: oauthToken);
                if (response == null)
                {
        ...
        {
            {
                var response = await HTTP.HTTP.PostAsync(new Uri(url + "/api/system", UriKind.Absolute), new HTTPOptions(TimeSpan.FromSeconds(30)), new StringContent(JsonConvert.SerializeObject(request)), token: oauthToken);
                if (response == null)
                {
                    return new APIResponse<object>(false);
                }
        ...
        {
            {
                var response = await HTTP.HTTP.GetAsync(new Uri(url + "/api/system/email/" + type + "", UriKind.Absolute), new HTTPOptions(TimeSpan.FromSeconds(30)), token: oauthToken);
                if (response == null)
                {
                    return new APIResponse<object>(false);
                }
        ...
        {
            {
                var response = await HTTP.HTTP.GetAsync(new Uri(url + "/api/system/email", UriKind.Absolute), new HTTPOptions(TimeSpan.FromSeconds(30)), token: oauthToken);
                if (response == null)
                {
                    return new APIResponse<object>(false);
                }
        ...
        {
            {
                var response = await HTTP.HTTP.PutAsync(new Uri(url + "/api/system/email", UriKind.Absolute), new HTTPOptions(TimeSpan.FromSeconds(30)), new StringContent(JsonConvert.SerializeObject(request)), token: oauthToken);
                if (response == null)
                {
                    return new APIResponse<object>(false);
                }
        ...
        {
            {
                var response = await HTTP.HTTP.GetAsync(new Uri(url + "/api/club/" + id + "/trending", UriKind.Absolute), new HTTPOptions(TimeSpan.FromSeconds(30)), token: oauthToken);
                if (response == null)
                {
                    return new APIResponse<BookItem[]>(false);
                }
        ...
        {
            {
                var response = await HTTP.HTTP.GetAsync(new Uri(url + "/api/book/trending", UriKind.Absolute), new HTTPOptions(TimeSpan.FromSeconds(30)), token: oauthToken);
                if (response == null)
                {
                    return new APIResponse<BookItem[]>(false);
                }
        ...
        {
            {
                var response = await HTTP.HTTP.DeleteAsync(new Uri(url + "/api/user/invite/" + inviteid + "", UriKind.Absolute), new HTTPOptions(TimeSpan.FromSeconds(30)), token: oauthToken);
                if (response == null)
                {
                    return new APIResponse<object>(false);
                }
        ...
        {
            {
                var response = await HTTP.HTTP.PutAsync(new Uri(url + "/api/user/invite/" + inviteid + "", UriKind.Absolute), new HTTPOptions(TimeSpan.FromSeconds(30)), token: oauthToken);
                if (response == null)
                {
                    return new APIResponse<object>(false);
                }
        ...
        {
            {
                var response = await HTTP.HTTP.DeleteAsync(new Uri(url + "/api/user/eventInvite/" + eventId + "", UriKind.Absolute), new HTTPOptions(TimeSpan.FromSeconds(30)), token: oauthToken);
                if (response == null)
                {
                    return new APIResponse<object>(false);
                }
        ...
        {
            {
                var response = await HTTP.HTTP.GetAsync(new Uri(url + "/api/user/books", UriKind.Absolute), new HTTPOptions(TimeSpan.FromSeconds(30)), token: oauthToken);
                if (response == null)
                {
                    return new APIResponse<CollectionResponseOfBookItem>(false);
                }
        ...
        {
            {
                var response = await HTTP.HTTP.GetAsync(new Uri(url + "/api/user/club", UriKind.Absolute), new HTTPOptions(TimeSpan.FromSeconds(30)), token: oauthToken);
                if (response == null)
                {
        ...
        {
            {
                var response = await HTTP.HTTP.GetAsync(new Uri(url + "/api/user/" + id + "/club", UriKind.Absolute), new HTTPOptions(TimeSpan.FromSeconds(30)), token: oauthToken);
                if (response == null)
                {
                    return new APIResponse<CollectionResponseOfClubGetUserResponse>(false);
                }
        ...
        {
            {
                var response = await HTTP.HTTP.GetAsync(new Uri(url + "/api/user/event", UriKind.Absolute), new HTTPOptions(TimeSpan.FromSeconds(30)), token: oauthToken);
                if (response == null)
                {
                    return new APIResponse<CollectionResponseOfRSVPItem>(false);
                }
        ...
        {
            {
                var response = await HTTP.HTTP.GetAsync(new Uri(url + "/api/user/invite", UriKind.Absolute), new HTTPOptions(TimeSpan.FromSeconds(30)), token: oauthToken);
                if (response == null)
                {
                    return new APIResponse<CollectionResponseOfClubInviteItem>(false);
                }
        ...
        {
            {
                var response = await HTTP.HTTP.GetAsync(new Uri(url + "/api/user/eventInvite", UriKind.Absolute), new HTTPOptions(TimeSpan.FromSeconds(30)), token: oauthToken);
                if (response == null)
                {
                    return new APIResponse<CollectionResponseOfEventItem>(false);
                }
        ...
        {
            {
                var response = await HTTP.HTTP.GetAsync(new Uri(url + "/api/user/reserve", UriKind.Absolute), new HTTPOptions(TimeSpan.FromSeconds(30)), token: oauthToken);
                if (response == null)
                {
        ...
        {
            {
                var response = await HTTP.HTTP.GetAsync(new Uri(url + "/api/user/" + id + "/ratings", UriKind.Absolute), new HTTPOptions(TimeSpan.FromSeconds(30)), token: oauthToken);
                if (response == null)
                {
        ...
        {
            {
                var response = await HTTP.HTTP.GetAsync(new Uri(url + "/api/user/ratings", UriKind.Absolute), new HTTPOptions(TimeSpan.FromSeconds(30)), token: oauthToken);
                if (response == null)
                {
                    return new APIResponse<CollectionResponseOfRatingResponse>(false);
                }
        ...
        {
            {
                var response = await HTTP.HTTP.GetAsync(new Uri(url + "/api/user/" + id + "/read", UriKind.Absolute), new HTTPOptions(TimeSpan.FromSeconds(30)), token: oauthToken);
                if (response == null)
                {
                    return new APIResponse<CollectionResponseOfReadResponseItem>(false);
                }
        ...
        {
            {
                var response = await HTTP.HTTP.GetAsync(new Uri(url + "/api/user/" + id + "/books", UriKind.Absolute), new HTTPOptions(TimeSpan.FromSeconds(30)), token: oauthToken);
                if (response == null)
                {
                    return new APIResponse<CollectionResponseOfBookItem>(false);
                }
        ...
        {
            {
                var response = await HTTP.HTTP.GetAsync(new Uri(url + "/api/user/" + id + "/reserve", UriKind.Absolute), new HTTPOptions(TimeSpan.FromSeconds(30)), token: oauthToken);
                if (response == null)
                {
                    return new APIResponse<CollectionResponseOfReservationResponseItem>(false);
                }
        ...
        {
            {
                var response = await HTTP.HTTP.GetAsync(new Uri(url + "/api/user/" + userId + "", UriKind.Absolute), new HTTPOptions(TimeSpan.FromSeconds(30)), token: oauthToken);
                if (response == null)
                {
        ...
        {
            {
                var response = await HTTP.HTTP.GetAsync(new Uri(url + "/api/user/" + id + "/wishlist", UriKind.Absolute), new HTTPOptions(TimeSpan.FromSeconds(30)), token: oauthToken);
                if (response == null)
                {
        ...
        {
            {
                var response = await HTTP.HTTP.GetAsync(new Uri(url + "/api/user/wishlist", UriKind.Absolute), new HTTPOptions(TimeSpan.FromSeconds(30)), token: oauthToken);
                if (response == null)
                {
                    return new APIResponse<CollectionResponseOfWishlistResponse>(false);
                }
        ...
        {
            {
                var response = await HTTP.HTTP.PostAsync(new Uri(url + "/api/user/search", UriKind.Absolute), new HTTPOptions(TimeSpan.FromSeconds(30)), new StringContent(JsonConvert.SerializeObject(request)), token: oauthToken);
                if (response == null)
                {
        ...
        {
            {
                var response = await HTTP.HTTP.PostAsync(new Uri(url + "/api/user/photo", UriKind.Absolute), new HTTPOptions(TimeSpan.FromSeconds(30)), new StringContent(JsonConvert.SerializeObject(photo)), token: oauthToken);
                if (response == null)
                {
                    return new APIResponse<object>(false);
                }
        ...
        {
            {
                var response = await HTTP.HTTP.GetAsync(new Uri(url + "/api/User", UriKind.Absolute), new HTTPOptions(TimeSpan.FromSeconds(30)), token: oauthToken);
                if (response == null)
                {
                    return new APIResponse<UserResponse>(false);
                }
        ...
        {
            {
                var response = await HTTP.HTTP.PostAsync(new Uri(url + "/api/User", UriKind.Absolute), new HTTPOptions(TimeSpan.FromSeconds(30)), new StringContent(JsonConvert.SerializeObject(request)));
                if (response == null)
                {
                    return new APIResponse<object>(false);
                }
        ...
        {
            {
                var response = await HTTP.HTTP.DeleteAsync(new Uri(url + "/api/Wishlist/" + id + "", UriKind.Absolute), new HTTPOptions(TimeSpan.FromSeconds(30)), token: oauthToken);
                if (response == null)
                {
                    return new APIResponse<object>(false);
                }
        ...
        {
            {
                var response = await HTTP.HTTP.PostAsync(new Uri(url + "/api/Wishlist", UriKind.Absolute), new HTTPOptions(TimeSpan.FromSeconds(30)), new StringContent(JsonConvert.SerializeObject(request)), token: oauthToken);
                if (response == null)
                {
                    return new APIResponse<string>(false);
                }
