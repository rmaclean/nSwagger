...
// This file was last generated at: 2016-04-08T12:37:55.7168652Z
namespace nSwagger
{
    using System;
    ...
    public class BookClubbingAPI
    {
        ...
        public async Task<APIResponse<BookItem>> Book_GetBookAdminAsync(string oauthToken, string id, Nullable<int> height, Nullable<int> width)
        {
            {
                var queryParameters = new Dictionary<string, object>(3);
                queryParameters.Add("id", id);
                if (height.HasValue)
                {
                    queryParameters.Add("height", height.Value);
                }

                if (width.HasValue)
                {
                    queryParameters.Add("width", width.Value);
                }

                var response = await httpClient.GetAsync(new Uri(url + "/api/book/admin" + "?" + queryParameters.Aggregate("", (curr, next) => (curr.Length > 0 ? "?" : "") + next.Key + "=" + next.Value), UriKind.Absolute), new SwaggerHTTPClientOptions(TimeSpan.FromSeconds(30)), token: oauthToken);
                if (response == null)
                {
                ...
                switch ((int)response.StatusCode)
                {
                    case 200:
                    {
                        ...
                        return new APIResponse<BookItem>(data, response.StatusCode);
                    }
        ...
        //<param name="height"></param>
        //<param name="width"></param>
        public async Task<APIResponse<CumulitiveRatingResponse>> Book_GetRatingsAsync(string oauthToken, string id, Nullable<int> skip, Nullable<int> top, Nullable<int> height, Nullable<int> width)
        {
            {
                var queryParameters = new Dictionary<string, object>(5);
                if (skip.HasValue)
                {
                ...
                var response = await httpClient.GetAsync(new Uri(url + "/api/book/" + id + "/ratings" + "?" + queryParameters.Aggregate("", (curr, next) => (curr.Length > 0 ? "?" : "") + next.Key + "=" + next.Value), UriKind.Absolute), new SwaggerHTTPClientOptions(TimeSpan.FromSeconds(30)), token: oauthToken);
                if (response == null)
                {
                ...
                switch ((int)response.StatusCode)
                {
                    ...
                    case 200:
                    {
                        ...
                        return new APIResponse<CumulitiveRatingResponse>(data, response.StatusCode);
                    }
        ...
        //<param name="height"></param>
        //<param name="width"></param>
        public async Task<APIResponse<Top10ResponseItem[]>> Book_GetTop10Async(string oauthToken, Nullable<int> height, Nullable<int> width)
        {
            {
                ...
                var response = await httpClient.GetAsync(new Uri(url + "/api/book/top10" + "?" + queryParameters.Aggregate("", (curr, next) => (curr.Length > 0 ? "?" : "") + next.Key + "=" + next.Value), UriKind.Absolute), new SwaggerHTTPClientOptions(TimeSpan.FromSeconds(30)), token: oauthToken);
                if (response == null)
                {
                ...
                switch ((int)response.StatusCode)
                {
                    case 200:
                    {
                        ...
                        return new APIResponse<Top10ResponseItem[]>(data, response.StatusCode);
                    }
        ...
        //<param name="height"></param>
        //<param name="width"></param>
        public async Task<APIResponse<BookItem>> Book_PostAsync(string oauthToken, AddBookToRequest request, Nullable<int> height, Nullable<int> width)
        {
            {
                var queryParameters = new Dictionary<string, object>(2);
                if (height.HasValue)
                ...
                var response = await httpClient.PostAsync(new Uri(url + "/api/book/add" + "?" + queryParameters.Aggregate("", (curr, next) => (curr.Length > 0 ? "?" : "") + next.Key + "=" + next.Value), UriKind.Absolute), new SwaggerHTTPClientOptions(TimeSpan.FromSeconds(30)), new StringContent(JsonConvert.SerializeObject(request)), token: oauthToken);
                if (response == null)
                {
                    return new APIResponse<BookItem>(false);
                }
        ...
        //<param name="height"></param>
        //<param name="width"></param>
        public async Task<APIResponse<BookItem[]>> Book_GetAsync(string oauthToken, double latitude, double longitude, string query, Nullable<int> height, Nullable<int> width)
        {
            {
                var queryParameters = new Dictionary<string, object>(5);
                ...
                var response = await httpClient.GetAsync(new Uri(url + "/api/Book" + "?" + queryParameters.Aggregate("", (curr, next) => (curr.Length > 0 ? "?" : "") + next.Key + "=" + next.Value), UriKind.Absolute), new SwaggerHTTPClientOptions(TimeSpan.FromSeconds(30)), token: oauthToken);
                if (response == null)
                {
                    return new APIResponse<BookItem[]>(false);
                }
        ...
        //<param name="height"></param>
        //<param name="width"></param>
        public async Task<APIResponse<ReadResponseItem>> BookRead_GetSingleReadAsync(string oauthToken, string id, Nullable<int> height, Nullable<int> width)
        {
            {
                var queryParameters = new Dictionary<string, object>(3);
                if (height.HasValue)
                ...
                var response = await httpClient.GetAsync(new Uri(url + "/api/book/read/" + id + "" + "?" + queryParameters.Aggregate("", (curr, next) => (curr.Length > 0 ? "?" : "") + next.Key + "=" + next.Value), UriKind.Absolute), new SwaggerHTTPClientOptions(TimeSpan.FromSeconds(30)), token: oauthToken);
                if (response == null)
                {
                ...
                switch ((int)response.StatusCode)
                {
                    ...
                    case 200:
                    {
                        ...
                        return new APIResponse<ReadResponseItem>(data, response.StatusCode);
                    }
        ...
        //<param name="height"></param>
        //<param name="width"></param>
        public async Task<APIResponse<CollectionResponseOfReadResponseItem>> BookRead_GetAsync(string oauthToken, Nullable<int> skip, Nullable<int> top, Nullable<int> height, Nullable<int> width)
        {
            {
                var queryParameters = new Dictionary<string, object>(4);
                if (skip.HasValue)
                {
                    queryParameters.Add("skip", skip.Value);
                }
                ...
                var response = await httpClient.GetAsync(new Uri(url + "/api/book/read" + "?" + queryParameters.Aggregate("", (curr, next) => (curr.Length > 0 ? "?" : "") + next.Key + "=" + next.Value), UriKind.Absolute), new SwaggerHTTPClientOptions(TimeSpan.FromSeconds(30)), token: oauthToken);
                if (response == null)
                {
                ...
                switch ((int)response.StatusCode)
                {
                    ...
                    case 200:
                    {
                        ...
                        return new APIResponse<CollectionResponseOfReadResponseItem>(data, response.StatusCode);
                    }
        ...
        //<param name="height"></param>
        //<param name="width"></param>
        public async Task<APIResponse<CollectionResponseOfClubGetMemberResponse>> Club_GetMembersAsync(string oauthToken, string id, string memberType, Nullable<bool> excludeSelf, Nullable<int> skip, Nullable<int> top, Nullable<int> height, Nullable<int> width)
        {
            {
                var queryParameters = new Dictionary<string, object>(7);
                queryParameters.Add("memberType", memberType);
                if (excludeSelf.HasValue)
                {
                    queryParameters.Add("excludeSelf", excludeSelf.Value);
                }
                ...
                var response = await httpClient.GetAsync(new Uri(url + "/api/club/" + id + "/members" + "?" + queryParameters.Aggregate("", (curr, next) => (curr.Length > 0 ? "?" : "") + next.Key + "=" + next.Value), UriKind.Absolute), new SwaggerHTTPClientOptions(TimeSpan.FromSeconds(30)), token: oauthToken);
                if (response == null)
                {
                ...
                switch ((int)response.StatusCode)
                {
                    ...
                    case 200:
                    {
                        ...
                        return new APIResponse<CollectionResponseOfClubGetMemberResponse>(data, response.StatusCode);
                    }
        ...
        //<param name="height"></param>
        //<param name="width"></param>
        public async Task<APIResponse<Top10ResponseItem[]>> Club_GetTop10Async(string oauthToken, string id, Nullable<int> height, Nullable<int> width)
        {
            {
                var queryParameters = new Dictionary<string, object>(3);
                if (height.HasValue)
                ...
                var response = await httpClient.GetAsync(new Uri(url + "/api/club/" + id + "/book/top10" + "?" + queryParameters.Aggregate("", (curr, next) => (curr.Length > 0 ? "?" : "") + next.Key + "=" + next.Value), UriKind.Absolute), new SwaggerHTTPClientOptions(TimeSpan.FromSeconds(30)), token: oauthToken);
                if (response == null)
                {
                    return new APIResponse<Top10ResponseItem[]>(false);
                }
        ...
        //<param name="skip"></param>
        //<param name="top"></param>
        public async Task<APIResponse<CollectionResponseOfClubResponseItem>> Club_PostSearchAsync(string oauthToken, ClubSearchRequest request, Nullable<int> skip, Nullable<int> top)
        {
            {
                var queryParameters = new Dictionary<string, object>(2);
                if (skip.HasValue)
                ...
                var response = await httpClient.PostAsync(new Uri(url + "/api/club/search" + "?" + queryParameters.Aggregate("", (curr, next) => (curr.Length > 0 ? "?" : "") + next.Key + "=" + next.Value), UriKind.Absolute), new SwaggerHTTPClientOptions(TimeSpan.FromSeconds(30)), new StringContent(JsonConvert.SerializeObject(request)), token: oauthToken);
                if (response == null)
                {
                ...
                switch ((int)response.StatusCode)
                {
                    ...
                    case 200:
                    {
                        ...
                        return new APIResponse<CollectionResponseOfClubResponseItem>(data, response.StatusCode);
                    }
        ...
        {
            {
                ...
                switch ((int)response.StatusCode)
                {
                    ...
                    case 200:
                    {
                        ...
                        return new APIResponse<ClubGetResponse>(data, response.StatusCode);
                    }
        ...
        //<param name="skip"></param>
        //<param name="top"></param>
        public async Task<APIResponse<CollectionResponseOfClubInviteItem>> ClubInvite_GetAsync(string oauthToken, string id, Nullable<int> skip, Nullable<int> top)
        {
            {
                var queryParameters = new Dictionary<string, object>(3);
                if (skip.HasValue)
                ...
                var response = await httpClient.GetAsync(new Uri(url + "/api/club/" + id + "/invite" + "?" + queryParameters.Aggregate("", (curr, next) => (curr.Length > 0 ? "?" : "") + next.Key + "=" + next.Value), UriKind.Absolute), new SwaggerHTTPClientOptions(TimeSpan.FromSeconds(30)), token: oauthToken);
                if (response == null)
                {
                ...
                switch ((int)response.StatusCode)
                {
                    ...
                    case 200:
                    {
                        ...
                        return new APIResponse<CollectionResponseOfClubInviteItem>(data, response.StatusCode);
                    }
        ...
        //<param name="skip"></param>
        //<param name="top"></param>
        public async Task<APIResponse<CollectionResponseOfBookItem>> ClubMember_GetMembersBooksAsync(string oauthToken, string clubId, string memberId, string filter, Nullable<int> height, Nullable<int> width, Nullable<int> skip, Nullable<int> top)
        {
            {
                var queryParameters = new Dictionary<string, object>(7);
                ...
                var response = await httpClient.GetAsync(new Uri(url + "/api/club/" + clubId + "/member/" + memberId + "" + "?" + queryParameters.Aggregate("", (curr, next) => (curr.Length > 0 ? "?" : "") + next.Key + "=" + next.Value), UriKind.Absolute), new SwaggerHTTPClientOptions(TimeSpan.FromSeconds(30)), token: oauthToken);
                if (response == null)
                {
                ...
                switch ((int)response.StatusCode)
                {
                    ...
                    case 200:
                    {
                        ...
                        return new APIResponse<CollectionResponseOfBookItem>(data, response.StatusCode);
                    }
        ...
        {
            {
                ...
                switch ((int)response.StatusCode)
                {
                    ...
                    case 200:
                    {
                        ...
                        return new APIResponse<EventItem>(data, response.StatusCode);
                    }
        ...
        //<param name="skip"></param>
        //<param name="top"></param>
        public async Task<APIResponse<CollectionResponseOfEventItem>> Event_GetEventsAsync(string oauthToken, string id, DateTime eventStartRangeBegin, DateTime eventStartRangeEnd, Nullable<int> skip, Nullable<int> top)
        {
            {
                var queryParameters = new Dictionary<string, object>(5);
                queryParameters.Add("eventStartRangeBegin", eventStartRangeBegin);
                queryParameters.Add("eventStartRangeEnd", eventStartRangeEnd);
                if (skip.HasValue)
                {
                    queryParameters.Add("skip", skip.Value);
                }
                ...
                var response = await httpClient.GetAsync(new Uri(url + "/api/club/" + id + "/event" + "?" + queryParameters.Aggregate("", (curr, next) => (curr.Length > 0 ? "?" : "") + next.Key + "=" + next.Value), UriKind.Absolute), new SwaggerHTTPClientOptions(TimeSpan.FromSeconds(30)), token: oauthToken);
                if (response == null)
                {
                ...
                switch ((int)response.StatusCode)
                {
                    ...
                    case 200:
                    {
                        ...
                        return new APIResponse<CollectionResponseOfEventItem>(data, response.StatusCode);
                    }
        ...
        {
            {
                ...
                switch ((int)response.StatusCode)
                {
                    ...
                    case 201:
                    {
                        ...
                        return new APIResponse<int>(data, response.StatusCode);
                    }
        ...
        //<param name="skip"></param>
        //<param name="top"></param>
        public async Task<APIResponse<GenreResponseItem[]>> Genres_GetAsync(string oauthToken, Nullable<int> skip, Nullable<int> top)
        {
            {
                var queryParameters = new Dictionary<string, object>(2);
                if (skip.HasValue)
                ...
                var response = await httpClient.GetAsync(new Uri(url + "/api/Genres" + "?" + queryParameters.Aggregate("", (curr, next) => (curr.Length > 0 ? "?" : "") + next.Key + "=" + next.Value), UriKind.Absolute), new SwaggerHTTPClientOptions(TimeSpan.FromSeconds(30)), token: oauthToken);
                if (response == null)
                {
                ...
                switch ((int)response.StatusCode)
                {
                    ...
                    case 200:
                    {
                        ...
                        return new APIResponse<GenreResponseItem[]>(data, response.StatusCode);
                    }
        ...
        {
            {
                ...
                switch ((int)response.StatusCode)
                {
                    case 200:
                    {
                        ...
                        return new APIResponse<SystemStatus>(data, response.StatusCode);
                    }
        ...
        //<param name="skip"></param>
        //<param name="top"></param>
        public async Task<APIResponse<CollectionResponseOfReservationResponseItem>> Reserve_GetAsync(string oauthToken, string id, Nullable<int> skip, Nullable<int> top)
        {
            {
                var queryParameters = new Dictionary<string, object>(3);
                if (skip.HasValue)
                ...
                var response = await httpClient.GetAsync(new Uri(url + "/api/Reserve/" + id + "" + "?" + queryParameters.Aggregate("", (curr, next) => (curr.Length > 0 ? "?" : "") + next.Key + "=" + next.Value), UriKind.Absolute), new SwaggerHTTPClientOptions(TimeSpan.FromSeconds(30)), token: oauthToken);
                if (response == null)
                {
                ...
                switch ((int)response.StatusCode)
                {
                    ...
                    case 200:
                    {
                        ...
                        return new APIResponse<CollectionResponseOfReservationResponseItem>(data, response.StatusCode);
                    }
        ...
        {
            {
                ...
                var response = await httpClient.PutAsync(new Uri(url + "/api/ReservedName/" + id + "" + "?" + queryParameters.Aggregate("", (curr, next) => (curr.Length > 0 ? "?" : "") + next.Key + "=" + next.Value), UriKind.Absolute), new SwaggerHTTPClientOptions(TimeSpan.FromSeconds(30)), token: oauthToken);
                if (response == null)
                {
                    return new APIResponse<object>(false);
                }
        ...
        {
            {
                ...
                queryParameters.Add("title", title);
                var response = await httpClient.PostAsync(new Uri(url + "/api/ReservedName" + "?" + queryParameters.Aggregate("", (curr, next) => (curr.Length > 0 ? "?" : "") + next.Key + "=" + next.Value), UriKind.Absolute), new SwaggerHTTPClientOptions(TimeSpan.FromSeconds(30)), token: oauthToken);
                if (response == null)
                {
                    return new APIResponse<object>(false);
                }
        ...
        //<param name="height"></param>
        //<param name="width"></param>
        public async Task<APIResponse<ResourceItem>> Resource_GetResourceAsync(string oauthToken, string id, string resourceId, Nullable<int> height, Nullable<int> width)
        {
            {
                var queryParameters = new Dictionary<string, object>(4);
                if (height.HasValue)
                ...
                var response = await httpClient.GetAsync(new Uri(url + "/api/club/" + id + "/resource/" + resourceId + "" + "?" + queryParameters.Aggregate("", (curr, next) => (curr.Length > 0 ? "?" : "") + next.Key + "=" + next.Value), UriKind.Absolute), new SwaggerHTTPClientOptions(TimeSpan.FromSeconds(30)), token: oauthToken);
                if (response == null)
                {
                ...
                switch ((int)response.StatusCode)
                {
                    ...
                    case 200:
                    {
                        ...
                        return new APIResponse<ResourceItem>(data, response.StatusCode);
                    }
        ...
        //<param name="height"></param>
        //<param name="width"></param>
        public async Task<APIResponse<ResourceCollection>> Resource_GetAsync(string oauthToken, string id, string resourceType, Nullable<int> skip, Nullable<int> top, Nullable<int> height, Nullable<int> width)
        {
            {
                var queryParameters = new Dictionary<string, object>(6);
                ...
                var response = await httpClient.GetAsync(new Uri(url + "/api/club/" + id + "/resource" + "?" + queryParameters.Aggregate("", (curr, next) => (curr.Length > 0 ? "?" : "") + next.Key + "=" + next.Value), UriKind.Absolute), new SwaggerHTTPClientOptions(TimeSpan.FromSeconds(30)), token: oauthToken);
                if (response == null)
                {
                ...
                switch ((int)response.StatusCode)
                {
                    ...
                    case 200:
                    {
                        ...
                        return new APIResponse<ResourceCollection>(data, response.StatusCode);
                    }
        ...
        //<param name="height"></param>
        //<param name="width"></param>
        public async Task<APIResponse<ResourceItem>> Resource_GetUserResourceAsync(string oauthToken, string resourceId, Nullable<int> height, Nullable<int> width)
        {
            {
                var queryParameters = new Dictionary<string, object>(3);
                if (height.HasValue)
                ...
                var response = await httpClient.GetAsync(new Uri(url + "/api/resource/" + resourceId + "" + "?" + queryParameters.Aggregate("", (curr, next) => (curr.Length > 0 ? "?" : "") + next.Key + "=" + next.Value), UriKind.Absolute), new SwaggerHTTPClientOptions(TimeSpan.FromSeconds(30)), token: oauthToken);
                if (response == null)
                {
                    return new APIResponse<ResourceItem>(false);
                }
        ...
        //<param name="skip"></param>
        //<param name="top"></param>
        public async Task<APIResponse<CollectionResponseOfRSVPItem>> RSVP_GetAsync(string oauthToken, string id, Nullable<int> skip, Nullable<int> top)
        {
            {
                var queryParameters = new Dictionary<string, object>(3);
                if (skip.HasValue)
                ...
                var response = await httpClient.GetAsync(new Uri(url + "/api/RSVP/" + id + "" + "?" + queryParameters.Aggregate("", (curr, next) => (curr.Length > 0 ? "?" : "") + next.Key + "=" + next.Value), UriKind.Absolute), new SwaggerHTTPClientOptions(TimeSpan.FromSeconds(30)), token: oauthToken);
                if (response == null)
                {
                ...
                switch ((int)response.StatusCode)
                {
                    ...
                    case 200:
                    {
                        ...
                        return new APIResponse<CollectionResponseOfRSVPItem>(data, response.StatusCode);
                    }
        ...
        {
            {
                var queryParameters = new Dictionary<string, object>(1);
                queryParameters.Add("id", id);
                var response = await httpClient.DeleteAsync(new Uri(url + "/api/system/quote" + "?" + queryParameters.Aggregate("", (curr, next) => (curr.Length > 0 ? "?" : "") + next.Key + "=" + next.Value), UriKind.Absolute), new SwaggerHTTPClientOptions(TimeSpan.FromSeconds(30)), token: oauthToken);
                if (response == null)
                {
                    return new APIResponse<object>(false);
                }
        ...
        {
            {
                ...
                var response = await httpClient.PostAsync(new Uri(url + "/api/system/quote" + "?" + queryParameters.Aggregate("", (curr, next) => (curr.Length > 0 ? "?" : "") + next.Key + "=" + next.Value), UriKind.Absolute), new SwaggerHTTPClientOptions(TimeSpan.FromSeconds(30)), token: oauthToken);
                if (response == null)
                {
                    return new APIResponse<object>(false);
                }
        ...
        {
            {
                ...
                switch ((int)response.StatusCode)
                {
                    case 200:
                    {
                        ...
                        return new APIResponse<SystemSettingItem>(data, response.StatusCode);
                    }
        ...
        //<param name="height"></param>
        //<param name="width"></param>
        public async Task<APIResponse<BookItem[]>> Trending_GetClubTrendingAsync(string oauthToken, string id, Nullable<bool> ageFilter, Nullable<bool> dateFilter, Nullable<int> endAgeRange, DateTime endDateRange, Nullable<int> limit, Nullable<int> startAgeRange, DateTime startDateRange, Nullable<int> height, Nullable<int> width)
        {
            {
                var queryParameters = new Dictionary<string, object>(10);
                if (ageFilter.HasValue)
                {
                    queryParameters.Add("ageFilter", ageFilter.Value);
                }

                if (dateFilter.HasValue)
                {
                    queryParameters.Add("dateFilter", dateFilter.Value);
                }

                if (endAgeRange.HasValue)
                {
                    queryParameters.Add("endAgeRange", endAgeRange.Value);
                }

                queryParameters.Add("endDateRange", endDateRange);
                if (limit.HasValue)
                {
                    queryParameters.Add("limit", limit.Value);
                }

                if (startAgeRange.HasValue)
                {
                    queryParameters.Add("startAgeRange", startAgeRange.Value);
                }

                queryParameters.Add("startDateRange", startDateRange);
                if (height.HasValue)
                {
                    queryParameters.Add("height", height.Value);
                }
                ...
                var response = await httpClient.GetAsync(new Uri(url + "/api/club/" + id + "/trending" + "?" + queryParameters.Aggregate("", (curr, next) => (curr.Length > 0 ? "?" : "") + next.Key + "=" + next.Value), UriKind.Absolute), new SwaggerHTTPClientOptions(TimeSpan.FromSeconds(30)), token: oauthToken);
                if (response == null)
                {
                    return new APIResponse<BookItem[]>(false);
                }
        ...
        //<param name="height"></param>
        //<param name="width"></param>
        public async Task<APIResponse<BookItem[]>> Trending_GetTrendingAsync(string oauthToken, Nullable<bool> ageFilter, Nullable<bool> dateFilter, Nullable<int> endAgeRange, DateTime endDateRange, Nullable<int> limit, Nullable<int> startAgeRange, DateTime startDateRange, Nullable<int> height, Nullable<int> width)
        {
            {
                var queryParameters = new Dictionary<string, object>(9);
                if (ageFilter.HasValue)
                {
                    queryParameters.Add("ageFilter", ageFilter.Value);
                }
                ...
                var response = await httpClient.GetAsync(new Uri(url + "/api/book/trending" + "?" + queryParameters.Aggregate("", (curr, next) => (curr.Length > 0 ? "?" : "") + next.Key + "=" + next.Value), UriKind.Absolute), new SwaggerHTTPClientOptions(TimeSpan.FromSeconds(30)), token: oauthToken);
                if (response == null)
                {
                    return new APIResponse<BookItem[]>(false);
                }
        ...
        //<param name="skip"></param>
        //<param name="top"></param>
        public async Task<APIResponse<CollectionResponseOfBookItem>> User_GetBooksAsync(string oauthToken, Nullable<int> skip, Nullable<int> top)
        {
            {
                var queryParameters = new Dictionary<string, object>(2);
                if (skip.HasValue)
                ...
                var response = await httpClient.GetAsync(new Uri(url + "/api/user/books" + "?" + queryParameters.Aggregate("", (curr, next) => (curr.Length > 0 ? "?" : "") + next.Key + "=" + next.Value), UriKind.Absolute), new SwaggerHTTPClientOptions(TimeSpan.FromSeconds(30)), token: oauthToken);
                if (response == null)
                {
                    return new APIResponse<CollectionResponseOfBookItem>(false);
                }
        ...
        //<param name="skip"></param>
        //<param name="top"></param>
        public async Task<APIResponse<CollectionResponseOfClubGetUserResponse>> User_GetClubsAsync(string oauthToken, Nullable<int> skip, Nullable<int> top)
        {
            {
                var queryParameters = new Dictionary<string, object>(2);
                if (skip.HasValue)
                ...
                var response = await httpClient.GetAsync(new Uri(url + "/api/user/club" + "?" + queryParameters.Aggregate("", (curr, next) => (curr.Length > 0 ? "?" : "") + next.Key + "=" + next.Value), UriKind.Absolute), new SwaggerHTTPClientOptions(TimeSpan.FromSeconds(30)), token: oauthToken);
                if (response == null)
                {
                ...
                switch ((int)response.StatusCode)
                {
                    ...
                    case 200:
                    {
                        ...
                        return new APIResponse<CollectionResponseOfClubGetUserResponse>(data, response.StatusCode);
                    }
        ...
        //<param name="skip"></param>
        //<param name="top"></param>
        public async Task<APIResponse<CollectionResponseOfClubGetUserResponse>> User_GetClubsForSpecifiedUserAsync(string oauthToken, string id, Nullable<int> skip, Nullable<int> top)
        {
            {
                var queryParameters = new Dictionary<string, object>(3);
                if (skip.HasValue)
                ...
                var response = await httpClient.GetAsync(new Uri(url + "/api/user/" + id + "/club" + "?" + queryParameters.Aggregate("", (curr, next) => (curr.Length > 0 ? "?" : "") + next.Key + "=" + next.Value), UriKind.Absolute), new SwaggerHTTPClientOptions(TimeSpan.FromSeconds(30)), token: oauthToken);
                if (response == null)
                {
                    return new APIResponse<CollectionResponseOfClubGetUserResponse>(false);
                }
        ...
        //<param name="skip"></param>
        //<param name="top"></param>
        public async Task<APIResponse<CollectionResponseOfRSVPItem>> User_GetEventsAsync(string oauthToken, DateTime eventStartRangeBegin, DateTime eventStartRangeEnd, Nullable<int> skip, Nullable<int> top)
        {
            {
                var queryParameters = new Dictionary<string, object>(4);
                queryParameters.Add("eventStartRangeBegin", eventStartRangeBegin);
                ...
                var response = await httpClient.GetAsync(new Uri(url + "/api/user/event" + "?" + queryParameters.Aggregate("", (curr, next) => (curr.Length > 0 ? "?" : "") + next.Key + "=" + next.Value), UriKind.Absolute), new SwaggerHTTPClientOptions(TimeSpan.FromSeconds(30)), token: oauthToken);
                if (response == null)
                {
                    return new APIResponse<CollectionResponseOfRSVPItem>(false);
                }
        ...
        //<param name="skip"></param>
        //<param name="top"></param>
        public async Task<APIResponse<CollectionResponseOfClubInviteItem>> User_GetInvitesAsync(string oauthToken, Nullable<int> skip, Nullable<int> top)
        {
            {
                var queryParameters = new Dictionary<string, object>(2);
                if (skip.HasValue)
                ...
                var response = await httpClient.GetAsync(new Uri(url + "/api/user/invite" + "?" + queryParameters.Aggregate("", (curr, next) => (curr.Length > 0 ? "?" : "") + next.Key + "=" + next.Value), UriKind.Absolute), new SwaggerHTTPClientOptions(TimeSpan.FromSeconds(30)), token: oauthToken);
                if (response == null)
                {
                    return new APIResponse<CollectionResponseOfClubInviteItem>(false);
                }
        ...
        //<param name="skip"></param>
        //<param name="top"></param>
        public async Task<APIResponse<CollectionResponseOfEventItem>> User_GetMyEventInviteAsync(string oauthToken, Nullable<int> skip, Nullable<int> top)
        {
            {
                var queryParameters = new Dictionary<string, object>(2);
                if (skip.HasValue)
                ...
                var response = await httpClient.GetAsync(new Uri(url + "/api/user/eventInvite" + "?" + queryParameters.Aggregate("", (curr, next) => (curr.Length > 0 ? "?" : "") + next.Key + "=" + next.Value), UriKind.Absolute), new SwaggerHTTPClientOptions(TimeSpan.FromSeconds(30)), token: oauthToken);
                if (response == null)
                {
                    return new APIResponse<CollectionResponseOfEventItem>(false);
                }
        ...
        //<param name="skip"></param>
        //<param name="top"></param>
        public async Task<APIResponse<ReservationResponseItem[]>> User_GetMyReservationsAsync(string oauthToken, Nullable<int> skip, Nullable<int> top)
        {
            {
                var queryParameters = new Dictionary<string, object>(2);
                if (skip.HasValue)
                ...
                var response = await httpClient.GetAsync(new Uri(url + "/api/user/reserve" + "?" + queryParameters.Aggregate("", (curr, next) => (curr.Length > 0 ? "?" : "") + next.Key + "=" + next.Value), UriKind.Absolute), new SwaggerHTTPClientOptions(TimeSpan.FromSeconds(30)), token: oauthToken);
                if (response == null)
                {
                ...
                switch ((int)response.StatusCode)
                {
                    ...
                    case 200:
                    {
                        ...
                        return new APIResponse<ReservationResponseItem[]>(data, response.StatusCode);
                    }
        ...
        //<param name="skip"></param>
        //<param name="top"></param>
        public async Task<APIResponse<CollectionResponseOfRatingResponse>> User_GetRatingsAsync(string oauthToken, string id, Nullable<int> skip, Nullable<int> top)
        {
            {
                var queryParameters = new Dictionary<string, object>(3);
                if (skip.HasValue)
                ...
                var response = await httpClient.GetAsync(new Uri(url + "/api/user/" + id + "/ratings" + "?" + queryParameters.Aggregate("", (curr, next) => (curr.Length > 0 ? "?" : "") + next.Key + "=" + next.Value), UriKind.Absolute), new SwaggerHTTPClientOptions(TimeSpan.FromSeconds(30)), token: oauthToken);
                if (response == null)
                {
                ...
                switch ((int)response.StatusCode)
                {
                    ...
                    case 200:
                    {
                        ...
                        return new APIResponse<CollectionResponseOfRatingResponse>(data, response.StatusCode);
                    }
        ...
        //<param name="skip"></param>
        //<param name="top"></param>
        public async Task<APIResponse<CollectionResponseOfRatingResponse>> User_GetRatingsAsync(string oauthToken, Nullable<int> skip, Nullable<int> top)
        {
            {
                var queryParameters = new Dictionary<string, object>(2);
                if (skip.HasValue)
                ...
                var response = await httpClient.GetAsync(new Uri(url + "/api/user/ratings" + "?" + queryParameters.Aggregate("", (curr, next) => (curr.Length > 0 ? "?" : "") + next.Key + "=" + next.Value), UriKind.Absolute), new SwaggerHTTPClientOptions(TimeSpan.FromSeconds(30)), token: oauthToken);
                if (response == null)
                {
                    return new APIResponse<CollectionResponseOfRatingResponse>(false);
                }
        ...
        //<param name="height"></param>
        //<param name="width"></param>
        public async Task<APIResponse<CollectionResponseOfReadResponseItem>> User_GetReadBooksAsync(string oauthToken, string id, Nullable<int> skip, Nullable<int> top, Nullable<int> height, Nullable<int> width)
        {
            {
                var queryParameters = new Dictionary<string, object>(5);
                if (skip.HasValue)
                ...
                var response = await httpClient.GetAsync(new Uri(url + "/api/user/" + id + "/read" + "?" + queryParameters.Aggregate("", (curr, next) => (curr.Length > 0 ? "?" : "") + next.Key + "=" + next.Value), UriKind.Absolute), new SwaggerHTTPClientOptions(TimeSpan.FromSeconds(30)), token: oauthToken);
                if (response == null)
                {
                    return new APIResponse<CollectionResponseOfReadResponseItem>(false);
                }
        ...
        //<param name="height"></param>
        //<param name="width"></param>
        public async Task<APIResponse<CollectionResponseOfBookItem>> User_GetSpecificUsersBooksAsync(string oauthToken, string id, Nullable<int> skip, Nullable<int> top, Nullable<int> height, Nullable<int> width)
        {
            {
                var queryParameters = new Dictionary<string, object>(5);
                if (skip.HasValue)
                ...
                var response = await httpClient.GetAsync(new Uri(url + "/api/user/" + id + "/books" + "?" + queryParameters.Aggregate("", (curr, next) => (curr.Length > 0 ? "?" : "") + next.Key + "=" + next.Value), UriKind.Absolute), new SwaggerHTTPClientOptions(TimeSpan.FromSeconds(30)), token: oauthToken);
                if (response == null)
                {
                    return new APIResponse<CollectionResponseOfBookItem>(false);
                }
        ...
        //<param name="skip"></param>
        //<param name="top"></param>
        public async Task<APIResponse<CollectionResponseOfReservationResponseItem>> User_GetSpecificUsersReservationsAsync(string oauthToken, string id, Nullable<int> skip, Nullable<int> top)
        {
            {
                var queryParameters = new Dictionary<string, object>(3);
                if (skip.HasValue)
                ...
                var response = await httpClient.GetAsync(new Uri(url + "/api/user/" + id + "/reserve" + "?" + queryParameters.Aggregate("", (curr, next) => (curr.Length > 0 ? "?" : "") + next.Key + "=" + next.Value), UriKind.Absolute), new SwaggerHTTPClientOptions(TimeSpan.FromSeconds(30)), token: oauthToken);
                if (response == null)
                {
                    return new APIResponse<CollectionResponseOfReservationResponseItem>(false);
                }
        ...
        //<param name="height"></param>
        //<param name="width"></param>
        public async Task<APIResponse<UserResponse>> User_GetSpecifiedUserAsync(string oauthToken, string userId, Nullable<int> height, Nullable<int> width)
        {
            {
                var queryParameters = new Dictionary<string, object>(3);
                if (height.HasValue)
                ...
                var response = await httpClient.GetAsync(new Uri(url + "/api/user/" + userId + "" + "?" + queryParameters.Aggregate("", (curr, next) => (curr.Length > 0 ? "?" : "") + next.Key + "=" + next.Value), UriKind.Absolute), new SwaggerHTTPClientOptions(TimeSpan.FromSeconds(30)), token: oauthToken);
                if (response == null)
                {
                ...
                switch ((int)response.StatusCode)
                {
                    ...
                    case 200:
                    {
                        ...
                        return new APIResponse<UserResponse>(data, response.StatusCode);
                    }
        ...
        //<param name="skip"></param>
        //<param name="top"></param>
        public async Task<APIResponse<CollectionResponseOfWishlistResponse>> User_GetSpecifiedWishlistAsync(string oauthToken, string id, Nullable<int> skip, Nullable<int> top)
        {
            {
                var queryParameters = new Dictionary<string, object>(3);
                if (skip.HasValue)
                ...
                var response = await httpClient.GetAsync(new Uri(url + "/api/user/" + id + "/wishlist" + "?" + queryParameters.Aggregate("", (curr, next) => (curr.Length > 0 ? "?" : "") + next.Key + "=" + next.Value), UriKind.Absolute), new SwaggerHTTPClientOptions(TimeSpan.FromSeconds(30)), token: oauthToken);
                if (response == null)
                {
                ...
                switch ((int)response.StatusCode)
                {
                    ...
                    case 200:
                    {
                        ...
                        return new APIResponse<CollectionResponseOfWishlistResponse>(data, response.StatusCode);
                    }
        ...
        //<param name="skip"></param>
        //<param name="top"></param>
        public async Task<APIResponse<CollectionResponseOfWishlistResponse>> User_GetWishlistAsync(string oauthToken, Nullable<int> skip, Nullable<int> top)
        {
            {
                var queryParameters = new Dictionary<string, object>(2);
                if (skip.HasValue)
                ...
                var response = await httpClient.GetAsync(new Uri(url + "/api/user/wishlist" + "?" + queryParameters.Aggregate("", (curr, next) => (curr.Length > 0 ? "?" : "") + next.Key + "=" + next.Value), UriKind.Absolute), new SwaggerHTTPClientOptions(TimeSpan.FromSeconds(30)), token: oauthToken);
                if (response == null)
                {
                    return new APIResponse<CollectionResponseOfWishlistResponse>(false);
                }
        ...
        //<param name="height"></param>
        //<param name="width"></param>
        public async Task<APIResponse<CollectionResponseOfUserSearchResponse>> User_PostFindUserAsync(string oauthToken, UserFindRequest request, Nullable<int> skip, Nullable<int> top, Nullable<int> height, Nullable<int> width)
        {
            {
                var queryParameters = new Dictionary<string, object>(4);
                if (skip.HasValue)
                ...
                var response = await httpClient.PostAsync(new Uri(url + "/api/user/search" + "?" + queryParameters.Aggregate("", (curr, next) => (curr.Length > 0 ? "?" : "") + next.Key + "=" + next.Value), UriKind.Absolute), new SwaggerHTTPClientOptions(TimeSpan.FromSeconds(30)), new StringContent(JsonConvert.SerializeObject(request)), token: oauthToken);
                if (response == null)
                {
                ...
                switch ((int)response.StatusCode)
                {
                    ...
                    case 200:
                    {
                        ...
                        return new APIResponse<CollectionResponseOfUserSearchResponse>(data, response.StatusCode);
                    }
        ...
        //<param name="height"></param>
        //<param name="width"></param>
        public async Task<APIResponse<UserResponse>> User_GetAsync(string oauthToken, Nullable<int> height, Nullable<int> width)
        {
            {
                var queryParameters = new Dictionary<string, object>(2);
                if (height.HasValue)
                ...
                var response = await httpClient.GetAsync(new Uri(url + "/api/User" + "?" + queryParameters.Aggregate("", (curr, next) => (curr.Length > 0 ? "?" : "") + next.Key + "=" + next.Value), UriKind.Absolute), new SwaggerHTTPClientOptions(TimeSpan.FromSeconds(30)), token: oauthToken);
                if (response == null)
                {
                    return new APIResponse<UserResponse>(false);
                }
