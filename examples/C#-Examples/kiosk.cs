...
namespace nSwagger
{
    ...
    public class API
    {
        ...
        {
            {
                var response = await HTTP.HTTP.PostAsync(new Uri(url + "/admin/newadmin", UriKind.Absolute), new HTTPOptions(TimeSpan.FromSeconds(30)), new StringContent(JsonConvert.SerializeObject(request)), token: oauthToken);
                if (response == null)
                {
        ...
        {
            {
                var response = await HTTP.HTTP.PostAsync(new Uri(url + "/admin/newkitchen", UriKind.Absolute), new HTTPOptions(TimeSpan.FromSeconds(30)), new StringContent(JsonConvert.SerializeObject(request)), token: oauthToken);
                if (response == null)
                {
                    return new APIResponse<object>(false);
                }
        ...
        {
            {
                var response = await HTTP.HTTP.DeleteAsync(new Uri(url + "/api/Admin/" + id + "", UriKind.Absolute), new HTTPOptions(TimeSpan.FromSeconds(30)), token: oauthToken);
                if (response == null)
                {
                    return new APIResponse<object>(false);
                }
        ...
        {
            {
                var response = await HTTP.HTTP.GetAsync(new Uri(url + "/api/Admin", UriKind.Absolute), new HTTPOptions(TimeSpan.FromSeconds(30)), token: oauthToken);
                if (response == null)
                {
        ...
        {
            {
                var response = await HTTP.HTTP.DeleteAsync(new Uri(url + "/cart/" + itemId + "/delete", UriKind.Absolute), new HTTPOptions(TimeSpan.FromSeconds(30)), token: oauthToken);
                if (response == null)
                {
                    return new APIResponse<object>(false);
                }
        ...
        {
            {
                var response = await HTTP.HTTP.PostAsync(new Uri(url + "/cart/" + orderId + "/" + state + "", UriKind.Absolute), new HTTPOptions(TimeSpan.FromSeconds(30)), token: oauthToken);
                if (response == null)
                {
                    return new APIResponse<object>(false);
                }
        ...
        {
            {
                var response = await HTTP.HTTP.PutAsync(new Uri(url + "/cart/" + id + "/update", UriKind.Absolute), new HTTPOptions(TimeSpan.FromSeconds(30)), new StringContent(JsonConvert.SerializeObject(request)), token: oauthToken);
                if (response == null)
                {
                    return new APIResponse<object>(false);
                }
        ...
        {
            {
                var response = await HTTP.HTTP.GetAsync(new Uri(url + "/api/Cart", UriKind.Absolute), new HTTPOptions(TimeSpan.FromSeconds(30)), token: oauthToken);
                if (response == null)
                {
        ...
        {
            {
                var response = await HTTP.HTTP.PostAsync(new Uri(url + "/api/Cart", UriKind.Absolute), new HTTPOptions(TimeSpan.FromSeconds(30)), new StringContent(JsonConvert.SerializeObject(request)), token: oauthToken);
                if (response == null)
                {
                    return new APIResponse<object>(false);
                }
        ...
        {
            {
                var response = await HTTP.HTTP.DeleteAsync(new Uri(url + "/api/Category/" + id + "", UriKind.Absolute), new HTTPOptions(TimeSpan.FromSeconds(30)), token: oauthToken);
                if (response == null)
                {
                    return new APIResponse<object>(false);
                }
        ...
        {
            {
                var response = await HTTP.HTTP.PostAsync(new Uri(url + "/api/Category/" + id + "", UriKind.Absolute), new HTTPOptions(TimeSpan.FromSeconds(30)), token: oauthToken);
                if (response == null)
                {
                    return new APIResponse<object>(false);
                }
        ...
        {
            {
                var response = await HTTP.HTTP.PutAsync(new Uri(url + "/api/Category/" + id + "", UriKind.Absolute), new HTTPOptions(TimeSpan.FromSeconds(30)), new StringContent(JsonConvert.SerializeObject(request)), token: oauthToken);
                if (response == null)
                {
                    return new APIResponse<object>(false);
                }
        ...
        {
            {
                var response = await HTTP.HTTP.GetAsync(new Uri(url + "/api/Category", UriKind.Absolute), new HTTPOptions(TimeSpan.FromSeconds(30)), token: oauthToken);
                if (response == null)
                {
        ...
        {
            {
                var response = await HTTP.HTTP.PostAsync(new Uri(url + "/api/Category", UriKind.Absolute), new HTTPOptions(TimeSpan.FromSeconds(30)), new StringContent(JsonConvert.SerializeObject(request)), token: oauthToken);
                if (response == null)
                {
                    return new APIResponse<object>(false);
                }
        ...
        {
            {
                var response = await HTTP.HTTP.PostAsync(new Uri(url + "/api/ConfirmUser", UriKind.Absolute), new HTTPOptions(TimeSpan.FromSeconds(30)), new StringContent(JsonConvert.SerializeObject(request)), token: oauthToken);
                if (response == null)
                {
                    return new APIResponse<object>(false);
                }
        ...
        {
            {
                var response = await HTTP.HTTP.GetAsync(new Uri(url + "/item/" + category + "", UriKind.Absolute), new HTTPOptions(TimeSpan.FromSeconds(30)), token: oauthToken);
                if (response == null)
                {
        ...
        {
            {
                var response = await HTTP.HTTP.PutAsync(new Uri(url + "/item/" + id + "/enable", UriKind.Absolute), new HTTPOptions(TimeSpan.FromSeconds(30)), token: oauthToken);
                if (response == null)
                {
                    return new APIResponse<object>(false);
                }
        ...
        {
            {
                var response = await HTTP.HTTP.PutAsync(new Uri(url + "/item/" + id + "/update", UriKind.Absolute), new HTTPOptions(TimeSpan.FromSeconds(30)), new StringContent(JsonConvert.SerializeObject(request)), token: oauthToken);
                if (response == null)
                {
                    return new APIResponse<object>(false);
                }
        ...
        {
            {
                var response = await HTTP.HTTP.DeleteAsync(new Uri(url + "/api/Item/" + id + "", UriKind.Absolute), new HTTPOptions(TimeSpan.FromSeconds(30)), token: oauthToken);
                if (response == null)
                {
                    return new APIResponse<object>(false);
                }
        ...
        {
            {
                var response = await HTTP.HTTP.PostAsync(new Uri(url + "/api/Item", UriKind.Absolute), new HTTPOptions(TimeSpan.FromSeconds(30)), new StringContent(JsonConvert.SerializeObject(request)), token: oauthToken);
                if (response == null)
                {
                    return new APIResponse<object>(false);
                }
        ...
        {
            {
                var response = await HTTP.HTTP.PostAsync(new Uri(url + "/login/forgotpassword", UriKind.Absolute), new HTTPOptions(TimeSpan.FromSeconds(30)), new StringContent(JsonConvert.SerializeObject(email)));
                if (response == null)
                {
                    return new APIResponse<object>(false);
                }
        ...
        {
            {
                var response = await HTTP.HTTP.PostAsync(new Uri(url + "/login/resetpassword", UriKind.Absolute), new HTTPOptions(TimeSpan.FromSeconds(30)), new StringContent(JsonConvert.SerializeObject(request)));
                if (response == null)
                {
                    return new APIResponse<object>(false);
                }
        ...
        {
            {
                var response = await HTTP.HTTP.GetAsync(new Uri(url + "/order/" + state + "/getbystate", UriKind.Absolute), new HTTPOptions(TimeSpan.FromSeconds(30)), token: oauthToken);
                if (response == null)
                {
        ...
        {
            {
                var response = await HTTP.HTTP.GetAsync(new Uri(url + "/order/getbydate", UriKind.Absolute), new HTTPOptions(TimeSpan.FromSeconds(30)), token: oauthToken);
                if (response == null)
                {
                    return new APIResponse<OrderResponse[]>(false);
                }
        ...
        {
            {
                var response = await HTTP.HTTP.GetAsync(new Uri(url + "/order/history", UriKind.Absolute), new HTTPOptions(TimeSpan.FromSeconds(30)), token: oauthToken);
                if (response == null)
                {
        ...
        {
            {
                var response = await HTTP.HTTP.PostAsync(new Uri(url + "/api/Reporting", UriKind.Absolute), new HTTPOptions(TimeSpan.FromSeconds(30)), new StringContent(JsonConvert.SerializeObject(request)), token: oauthToken);
                if (response == null)
                {
                    return new APIResponse<object>(false);
                }
        ...
        {
            {
                var response = await HTTP.HTTP.PostAsync(new Uri(url + "/signup/resend", UriKind.Absolute), new HTTPOptions(TimeSpan.FromSeconds(30)), new StringContent(JsonConvert.SerializeObject(request)));
                if (response == null)
                {
                    return new APIResponse<object>(false);
                }
        ...
        {
            {
                var response = await HTTP.HTTP.PostAsync(new Uri(url + "/api/Signup", UriKind.Absolute), new HTTPOptions(TimeSpan.FromSeconds(30)), new StringContent(JsonConvert.SerializeObject(request)));
                if (response == null)
                {
                    return new APIResponse<object>(false);
                }
        ...
        {
            {
                var response = await HTTP.HTTP.GetAsync(new Uri(url + "/api/TradingHours", UriKind.Absolute), new HTTPOptions(TimeSpan.FromSeconds(30)), token: oauthToken);
                if (response == null)
                {
        ...
        {
            {
                var response = await HTTP.HTTP.PostAsync(new Uri(url + "/api/TradingHours", UriKind.Absolute), new HTTPOptions(TimeSpan.FromSeconds(30)), new StringContent(JsonConvert.SerializeObject(request)), token: oauthToken);
                if (response == null)
                {
                    return new APIResponse<TradingHourResponse>(false);
                }
        ...
        {
            {
                var response = await HTTP.HTTP.PutAsync(new Uri(url + "/api/TradingHours/" + id + "", UriKind.Absolute), new HTTPOptions(TimeSpan.FromSeconds(30)), new StringContent(JsonConvert.SerializeObject(request)), token: oauthToken);
                if (response == null)
                {
                    return new APIResponse<TradingHourResponse>(false);
                }
        ...
        {
            {
                var response = await HTTP.HTTP.PutAsync(new Uri(url + "/user/" + id + "/disable", UriKind.Absolute), new HTTPOptions(TimeSpan.FromSeconds(30)), token: oauthToken);
                if (response == null)
                {
                    return new APIResponse<object>(false);
                }
        ...
        {
            {
                var response = await HTTP.HTTP.PutAsync(new Uri(url + "/user/" + id + "/enable", UriKind.Absolute), new HTTPOptions(TimeSpan.FromSeconds(30)), token: oauthToken);
                if (response == null)
                {
                    return new APIResponse<object>(false);
                }
        ...
        {
            {
                var response = await HTTP.HTTP.PutAsync(new Uri(url + "/user/" + id + "/" + role + "", UriKind.Absolute), new HTTPOptions(TimeSpan.FromSeconds(30)), token: oauthToken);
                if (response == null)
                {
                    return new APIResponse<object>(false);
                }
