...
namespace nSwagger
{
    ...
    public class Portal
    {
        ...
        {
            {
                var response = await HTTP.HTTP.GetAsync(new Uri(url + "/api/Admins/" + id + "", UriKind.Absolute), new HTTPOptions(TimeSpan.FromSeconds(30)), token: oauthToken);
                if (response == null)
                {
        ...
        {
            {
                var response = await HTTP.HTTP.PutAsync(new Uri(url + "/api/Admins/" + id + "", UriKind.Absolute), new HTTPOptions(TimeSpan.FromSeconds(30)), new StringContent(JsonConvert.SerializeObject(request)), token: oauthToken);
                if (response == null)
                {
                    return new APIResponse<AdminResponse[]>(false);
                }
        ...
        {
            {
                var response = await HTTP.HTTP.GetAsync(new Uri(url + "/api/Admins", UriKind.Absolute), new HTTPOptions(TimeSpan.FromSeconds(30)), token: oauthToken);
                if (response == null)
                {
        ...
        {
            {
                var response = await HTTP.HTTP.PostAsync(new Uri(url + "/api/Admins", UriKind.Absolute), new HTTPOptions(TimeSpan.FromSeconds(30)), new StringContent(JsonConvert.SerializeObject(request)), token: oauthToken);
                if (response == null)
                {
                    return new APIResponse<AdminResponse[]>(false);
                }
        ...
        {
            {
                var response = await HTTP.HTTP.DeleteAsync(new Uri(url + "/api/calendar/" + id + "/" + calendarId + "", UriKind.Absolute), new HTTPOptions(TimeSpan.FromSeconds(30)), token: oauthToken);
                if (response == null)
                {
        ...
        {
            {
                var response = await HTTP.HTTP.PostAsync(new Uri(url + "/api/calendar/share", UriKind.Absolute), new HTTPOptions(TimeSpan.FromSeconds(30)), new StringContent(JsonConvert.SerializeObject(request)), token: oauthToken);
                if (response == null)
                {
                    return new APIResponse<object>(false);
                }
        ...
        {
            {
                var response = await HTTP.HTTP.GetAsync(new Uri(url + "/api/Calendar", UriKind.Absolute), new HTTPOptions(TimeSpan.FromSeconds(30)), token: oauthToken);
                if (response == null)
                {
        ...
        {
            {
                var response = await HTTP.HTTP.PostAsync(new Uri(url + "/api/Calendar", UriKind.Absolute), new HTTPOptions(TimeSpan.FromSeconds(30)), new StringContent(JsonConvert.SerializeObject(calendar)), token: oauthToken);
                if (response == null)
                {
        ...
        {
            {
                var response = await HTTP.HTTP.GetAsync(new Uri(url + "/api/Calendar/" + id + "", UriKind.Absolute), new HTTPOptions(TimeSpan.FromSeconds(30)), token: oauthToken);
                if (response == null)
                {
                    return new APIResponse<CalendarResponse>(false);
                }
        ...
        {
            {
                var response = await HTTP.HTTP.PutAsync(new Uri(url + "/api/courses/" + id + "/disable", UriKind.Absolute), new HTTPOptions(TimeSpan.FromSeconds(30)), token: oauthToken);
                if (response == null)
                {
                    return new APIResponse<object>(false);
                }
        ...
        {
            {
                var response = await HTTP.HTTP.PutAsync(new Uri(url + "/api/courses/" + id + "/enable", UriKind.Absolute), new HTTPOptions(TimeSpan.FromSeconds(30)), token: oauthToken);
                if (response == null)
                {
                    return new APIResponse<object>(false);
                }
        ...
        {
            {
                var response = await HTTP.HTTP.GetAsync(new Uri(url + "/api/Courses", UriKind.Absolute), new HTTPOptions(TimeSpan.FromSeconds(30)), token: oauthToken);
                if (response == null)
                {
        ...
        {
            {
                var response = await HTTP.HTTP.PostAsync(new Uri(url + "/api/Courses", UriKind.Absolute), new HTTPOptions(TimeSpan.FromSeconds(30)), new StringContent(JsonConvert.SerializeObject(course)), token: oauthToken);
                if (response == null)
                {
        ...
        {
            {
                var response = await HTTP.HTTP.GetAsync(new Uri(url + "/api/Courses/" + id + "", UriKind.Absolute), new HTTPOptions(TimeSpan.FromSeconds(30)), token: oauthToken);
                if (response == null)
                {
                    return new APIResponse<CourseResponse>(false);
                }
        ...
        {
            {
                var response = await HTTP.HTTP.PutAsync(new Uri(url + "/api/Courses/" + id + "", UriKind.Absolute), new HTTPOptions(TimeSpan.FromSeconds(30)), new StringContent(JsonConvert.SerializeObject(request)), token: oauthToken);
                if (response == null)
                {
                    return new APIResponse<object>(false);
                }
        ...
        {
            {
                var response = await HTTP.HTTP.GetAsync(new Uri(url + "/api/DroppedOut", UriKind.Absolute), new HTTPOptions(TimeSpan.FromSeconds(30)), token: oauthToken);
                if (response == null)
                {
        ...
        {
            {
                var response = await HTTP.HTTP.GetAsync(new Uri(url + "/api/DroppedOut/" + id + "", UriKind.Absolute), new HTTPOptions(TimeSpan.FromSeconds(30)), token: oauthToken);
                if (response == null)
                {
        ...
        {
            {
                var response = await HTTP.HTTP.PostAsync(new Uri(url + "/api/DroppedOut/" + id + "", UriKind.Absolute), new HTTPOptions(TimeSpan.FromSeconds(30)), new StringContent(JsonConvert.SerializeObject(request)), token: oauthToken);
                if (response == null)
                {
                    return new APIResponse<object>(false);
                }
        ...
        {
            {
                var response = await HTTP.HTTP.PutAsync(new Uri(url + "/api/exam/" + id + "/disable", UriKind.Absolute), new HTTPOptions(TimeSpan.FromSeconds(30)), token: oauthToken);
                if (response == null)
                {
                    return new APIResponse<object>(false);
                }
        ...
        {
            {
                var response = await HTTP.HTTP.PutAsync(new Uri(url + "/api/exam/" + id + "/enable", UriKind.Absolute), new HTTPOptions(TimeSpan.FromSeconds(30)), token: oauthToken);
                if (response == null)
                {
                    return new APIResponse<object>(false);
                }
        ...
        {
            {
                var response = await HTTP.HTTP.GetAsync(new Uri(url + "/api/Exam", UriKind.Absolute), new HTTPOptions(TimeSpan.FromSeconds(30)), token: oauthToken);
                if (response == null)
                {
        ...
        {
            {
                var response = await HTTP.HTTP.PostAsync(new Uri(url + "/api/Exam", UriKind.Absolute), new HTTPOptions(TimeSpan.FromSeconds(30)), new StringContent(JsonConvert.SerializeObject(exam)), token: oauthToken);
                if (response == null)
                {
        ...
        {
            {
                var response = await HTTP.HTTP.GetAsync(new Uri(url + "/api/Exam/" + id + "", UriKind.Absolute), new HTTPOptions(TimeSpan.FromSeconds(30)), token: oauthToken);
                if (response == null)
                {
                    return new APIResponse<ExamResponse>(false);
                }
        ...
        {
            {
                var response = await HTTP.HTTP.PutAsync(new Uri(url + "/api/Exam/" + id + "", UriKind.Absolute), new HTTPOptions(TimeSpan.FromSeconds(30)), new StringContent(JsonConvert.SerializeObject(request)), token: oauthToken);
                if (response == null)
                {
                    return new APIResponse<object>(false);
                }
        ...
        {
            {
                var response = await HTTP.HTTP.GetAsync(new Uri(url + "/api/Feedback", UriKind.Absolute), new HTTPOptions(TimeSpan.FromSeconds(30)), token: oauthToken);
                if (response == null)
                {
        ...
        {
            {
                var response = await HTTP.HTTP.PostAsync(new Uri(url + "/api/Feedback", UriKind.Absolute), new HTTPOptions(TimeSpan.FromSeconds(30)), new StringContent(JsonConvert.SerializeObject(feedback)), token: oauthToken);
                if (response == null)
                {
        ...
        {
            {
                var response = await HTTP.HTTP.GetAsync(new Uri(url + "/api/Feedback/" + id + "", UriKind.Absolute), new HTTPOptions(TimeSpan.FromSeconds(30)), token: oauthToken);
                if (response == null)
                {
                    return new APIResponse<FeedbackResponse>(false);
                }
        ...
        {
            {
                var response = await HTTP.HTTP.GetAsync(new Uri(url + "/api/students/furtherEmployment", UriKind.Absolute), new HTTPOptions(TimeSpan.FromSeconds(30)), token: oauthToken);
                if (response == null)
                {
        ...
        {
            {
                var response = await HTTP.HTTP.GetAsync(new Uri(url + "/api/students/" + id + "/furtherEmployment", UriKind.Absolute), new HTTPOptions(TimeSpan.FromSeconds(30)), token: oauthToken);
                if (response == null)
                {
        ...
        {
            {
                var response = await HTTP.HTTP.PostAsync(new Uri(url + "/api/students/" + id + "/furtherEmployment", UriKind.Absolute), new HTTPOptions(TimeSpan.FromSeconds(30)), new StringContent(JsonConvert.SerializeObject(request)), token: oauthToken);
                if (response == null)
                {
                    return new APIResponse<object>(false);
                }
        ...
        {
            {
                var response = await HTTP.HTTP.PostAsync(new Uri(url + "/api/students/" + id + "/host/" + hostId + "", UriKind.Absolute), new HTTPOptions(TimeSpan.FromSeconds(30)), token: oauthToken);
                if (response == null)
                {
                    return new APIResponse<object>(false);
                }
        ...
        {
            {
                var response = await HTTP.HTTP.PutAsync(new Uri(url + "/api/hostEmployers/" + id + "/disable", UriKind.Absolute), new HTTPOptions(TimeSpan.FromSeconds(30)), token: oauthToken);
                if (response == null)
                {
                    return new APIResponse<object>(false);
                }
        ...
        {
            {
                var response = await HTTP.HTTP.PutAsync(new Uri(url + "/api/hostEmployers/" + id + "/enable", UriKind.Absolute), new HTTPOptions(TimeSpan.FromSeconds(30)), token: oauthToken);
                if (response == null)
                {
                    return new APIResponse<object>(false);
                }
        ...
        {
            {
                var response = await HTTP.HTTP.GetAsync(new Uri(url + "/api/HostEmployer/" + id + "", UriKind.Absolute), new HTTPOptions(TimeSpan.FromSeconds(30)), token: oauthToken);
                if (response == null)
                {
        ...
        {
            {
                var response = await HTTP.HTTP.PutAsync(new Uri(url + "/api/HostEmployer/" + id + "", UriKind.Absolute), new HTTPOptions(TimeSpan.FromSeconds(30)), new StringContent(JsonConvert.SerializeObject(request)), token: oauthToken);
                if (response == null)
                {
        ...
        {
            {
                var response = await HTTP.HTTP.GetAsync(new Uri(url + "/api/HostEmployer", UriKind.Absolute), new HTTPOptions(TimeSpan.FromSeconds(30)), token: oauthToken);
                if (response == null)
                {
        ...
        {
            {
                var response = await HTTP.HTTP.PostAsync(new Uri(url + "/api/HostEmployer", UriKind.Absolute), new HTTPOptions(TimeSpan.FromSeconds(30)), new StringContent(JsonConvert.SerializeObject(hostEmployer)), token: oauthToken);
                if (response == null)
                {
        ...
        {
            {
                var response = await HTTP.HTTP.PostAsync(new Uri(url + "/api/login/confirmPasswordReset", UriKind.Absolute), new HTTPOptions(TimeSpan.FromSeconds(30)), new StringContent(JsonConvert.SerializeObject(request)));
                if (response == null)
                {
                    return new APIResponse<object>(false);
                }
        ...
        {
            {
                var response = await HTTP.HTTP.PostAsync(new Uri(url + "/api/login/beginPasswordReset", UriKind.Absolute), new HTTPOptions(TimeSpan.FromSeconds(30)), new StringContent(JsonConvert.SerializeObject(request)));
                if (response == null)
                {
                    return new APIResponse<object>(false);
                }
        ...
        {
            {
                var response = await HTTP.HTTP.PostAsync(new Uri(url + "/api/Login", UriKind.Absolute), new HTTPOptions(TimeSpan.FromSeconds(30)), new StringContent(JsonConvert.SerializeObject(request)));
                if (response == null)
                {
        ...
        {
            {
                var response = await HTTP.HTTP.PutAsync(new Uri(url + "/api/rewards/" + id + "/disable", UriKind.Absolute), new HTTPOptions(TimeSpan.FromSeconds(30)), token: oauthToken);
                if (response == null)
                {
                    return new APIResponse<object>(false);
                }
        ...
        {
            {
                var response = await HTTP.HTTP.PutAsync(new Uri(url + "/api/rewards/" + id + "/enable", UriKind.Absolute), new HTTPOptions(TimeSpan.FromSeconds(30)), token: oauthToken);
                if (response == null)
                {
                    return new APIResponse<object>(false);
                }
        ...
        {
            {
                var response = await HTTP.HTTP.GetAsync(new Uri(url + "/api/Reward/" + id + "", UriKind.Absolute), new HTTPOptions(TimeSpan.FromSeconds(30)), token: oauthToken);
                if (response == null)
                {
        ...
        {
            {
                var response = await HTTP.HTTP.PostAsync(new Uri(url + "/api/Reward/" + id + "", UriKind.Absolute), new HTTPOptions(TimeSpan.FromSeconds(30)), token: oauthToken);
                if (response == null)
                {
                    return new APIResponse<object>(false);
                }
        ...
        {
            {
                var response = await HTTP.HTTP.PutAsync(new Uri(url + "/api/Reward/" + id + "", UriKind.Absolute), new HTTPOptions(TimeSpan.FromSeconds(30)), new StringContent(JsonConvert.SerializeObject(request)), token: oauthToken);
                if (response == null)
                {
                    return new APIResponse<object>(false);
                }
        ...
        {
            {
                var response = await HTTP.HTTP.GetAsync(new Uri(url + "/api/Reward", UriKind.Absolute), new HTTPOptions(TimeSpan.FromSeconds(30)), token: oauthToken);
                if (response == null)
                {
        ...
        {
            {
                var response = await HTTP.HTTP.PostAsync(new Uri(url + "/api/Reward", UriKind.Absolute), new HTTPOptions(TimeSpan.FromSeconds(30)), new StringContent(JsonConvert.SerializeObject(reward)), token: oauthToken);
                if (response == null)
                {
                    return new APIResponse<RewardResponse>(false);
                }
        ...
        {
            {
                var response = await HTTP.HTTP.GetAsync(new Uri(url + "/api/students/" + id + "/rewards", UriKind.Absolute), new HTTPOptions(TimeSpan.FromSeconds(30)), token: oauthToken);
                if (response == null)
                {
        ...
        {
            {
                var response = await HTTP.HTTP.GetAsync(new Uri(url + "/api/students/" + id + "/trainingproviders", UriKind.Absolute), new HTTPOptions(TimeSpan.FromSeconds(30)), new StringContent(JsonConvert.SerializeObject(param)), token: oauthToken);
                if (response == null)
                {
        ...
        {
            {
                var response = await HTTP.HTTP.PostAsync(new Uri(url + "/api/students/addExams", UriKind.Absolute), new HTTPOptions(TimeSpan.FromSeconds(30)), new StringContent(JsonConvert.SerializeObject(request)), token: oauthToken);
                if (response == null)
                {
                    return new APIResponse<object>(false);
                }
        ...
        {
            {
                var response = await HTTP.HTTP.GetAsync(new Uri(url + "/api/Students/" + id + "", UriKind.Absolute), new HTTPOptions(TimeSpan.FromSeconds(30)), token: oauthToken);
                if (response == null)
                {
                    return new APIResponse<StudentResponse>(false);
                }
        ...
        {
            {
                var response = await HTTP.HTTP.PutAsync(new Uri(url + "/api/Students/" + id + "", UriKind.Absolute), new HTTPOptions(TimeSpan.FromSeconds(30)), new StringContent(JsonConvert.SerializeObject(request)), token: oauthToken);
                if (response == null)
                {
                    return new APIResponse<object>(false);
                }
        ...
        {
            {
                var response = await HTTP.HTTP.GetAsync(new Uri(url + "/api/Students", UriKind.Absolute), new HTTPOptions(TimeSpan.FromSeconds(30)), token: oauthToken);
                if (response == null)
                {
        ...
        {
            {
                var response = await HTTP.HTTP.PostAsync(new Uri(url + "/api/Students", UriKind.Absolute), new HTTPOptions(TimeSpan.FromSeconds(30)), new StringContent(JsonConvert.SerializeObject(request)), token: oauthToken);
                if (response == null)
                {
                    return new APIResponse<StudentResponse>(false);
                }
        ...
        {
            {
                var response = await HTTP.HTTP.DeleteAsync(new Uri(url + "/api/trainingproviders/" + id + "/" + courseId + "", UriKind.Absolute), new HTTPOptions(TimeSpan.FromSeconds(30)), token: oauthToken);
                if (response == null)
                {
                    return new APIResponse<object>(false);
                }
        ...
        {
            {
                var response = await HTTP.HTTP.PostAsync(new Uri(url + "/api/trainingproviders/addCourse", UriKind.Absolute), new HTTPOptions(TimeSpan.FromSeconds(30)), new StringContent(JsonConvert.SerializeObject(request)), token: oauthToken);
                if (response == null)
                {
                    return new APIResponse<object>(false);
                }
        ...
        {
            {
                var response = await HTTP.HTTP.PutAsync(new Uri(url + "/api/trainingproviders/" + id + "/disable", UriKind.Absolute), new HTTPOptions(TimeSpan.FromSeconds(30)), token: oauthToken);
                if (response == null)
                {
                    return new APIResponse<object>(false);
                }
        ...
        {
            {
                var response = await HTTP.HTTP.GetAsync(new Uri(url + "/api/TrainingProviders/" + id + "", UriKind.Absolute), new HTTPOptions(TimeSpan.FromSeconds(30)), token: oauthToken);
                if (response == null)
                {
                    return new APIResponse<TrainingProviderResponse>(false);
                }
        ...
        {
            {
                var response = await HTTP.HTTP.PutAsync(new Uri(url + "/api/TrainingProviders/" + id + "", UriKind.Absolute), new HTTPOptions(TimeSpan.FromSeconds(30)), new StringContent(JsonConvert.SerializeObject(request)), token: oauthToken);
                if (response == null)
                {
                    return new APIResponse<TrainingProviderResponse[]>(false);
                }
        ...
        {
            {
                var response = await HTTP.HTTP.GetAsync(new Uri(url + "/api/TrainingProviders", UriKind.Absolute), new HTTPOptions(TimeSpan.FromSeconds(30)), token: oauthToken);
                if (response == null)
                {
                    return new APIResponse<CollectionResponseOfTrainingProviderResponse>(false);
                }
        ...
        {
            {
                var response = await HTTP.HTTP.PostAsync(new Uri(url + "/api/TrainingProviders", UriKind.Absolute), new HTTPOptions(TimeSpan.FromSeconds(30)), new StringContent(JsonConvert.SerializeObject(trainingProvider)), token: oauthToken);
                if (response == null)
                {
                    return new APIResponse<TrainingProviderResponse>(false);
                }
        ...
        {
            {
                var response = await HTTP.HTTP.PutAsync(new Uri(url + "/api/TrainingProviders", UriKind.Absolute), new HTTPOptions(TimeSpan.FromSeconds(30)), new StringContent(JsonConvert.SerializeObject(courseRequest)), token: oauthToken);
                if (response == null)
                {
                    return new APIResponse<object>(false);
                }
        ...
        {
            {
                var response = await HTTP.HTTP.PostAsync(new Uri(url + "/api/users/" + id + "/password", UriKind.Absolute), new HTTPOptions(TimeSpan.FromSeconds(30)), new StringContent(JsonConvert.SerializeObject(request)), token: oauthToken);
                if (response == null)
                {
                    return new APIResponse<object>(false);
                }
        ...
        {
            {
                var response = await HTTP.HTTP.PutAsync(new Uri(url + "/api/users/" + id + "/disable", UriKind.Absolute), new HTTPOptions(TimeSpan.FromSeconds(30)), token: oauthToken);
                if (response == null)
                {
                    return new APIResponse<object>(false);
                }
        ...
        {
            {
                var response = await HTTP.HTTP.PutAsync(new Uri(url + "/api/users/" + id + "/enable", UriKind.Absolute), new HTTPOptions(TimeSpan.FromSeconds(30)), token: oauthToken);
                if (response == null)
                {
                    return new APIResponse<object>(false);
                }
