...
// This file was last generated at: 2016-04-08T12:38:37.0845513Z
namespace nSwagger
{
    using System;
    ...
    public class Portal
    {
        ...
        [System.Diagnostics.CodeAnalysis.SuppressMessage("", "RECS0001:Class is declared partial but has only one part", Justification = "This is partial to allow the file to extended in a seperate file if needed. Changes to this file would be lost when the code is regenerated and so supporting a seperate file for this is ideal.")]
        public partial class StudentCalendarInfomationRequest
        {
            public DateTime End
            {
                get;
        ...
        public partial class User
        {
            ...
            public DateTime FurtherEmploymentEndDate
            {
                get;
                set;
            }
        ...
        [System.Diagnostics.CodeAnalysis.SuppressMessage("", "RECS0001:Class is declared partial but has only one part", Justification = "This is partial to allow the file to extended in a seperate file if needed. Changes to this file would be lost when the code is regenerated and so supporting a seperate file for this is ideal.")]
        public partial class AddStudentToCourseRequest
        {
            public int CourseId
            {
                get;
        ...
        [System.Diagnostics.CodeAnalysis.SuppressMessage("", "RECS0001:Class is declared partial but has only one part", Justification = "This is partial to allow the file to extended in a seperate file if needed. Changes to this file would be lost when the code is regenerated and so supporting a seperate file for this is ideal.")]
        public partial class AddStudentToExamRequest
        {
            public int ExamId
            {
                get;
        ...
        public partial class LoginResponse
        {
            ...
            public enum LoginResponseStudentState
            {
                NotAStudent,
                Active,
                DroppedOut,
            ...
            public LoginResponseStudentState StudentState
            {
                get;
                set;
            }
        ...
        //<param name="oauthToken"></param>
        //<param name="id"></param>
        //<param name="request">Admin First Name and Last Name</param>
        public async Task<APIResponse<object>> Admins_PutUpdateAdminAsync(string oauthToken, string id, UpdateAdminRequest request)
        {
            {
        ...
        public async Task<APIResponse<CollectionResponseOfAdminResponse>> Admins_GetAdminsAsync(string oauthToken, Nullable<int> skip, Nullable<int> top)
        {
            {
                ...
                var response = await httpClient.GetAsync(new Uri(url + "/api/Admins" + "?" + queryParameters.Aggregate("", (curr, next) => (curr.Length > 0 ? "?" : "") + next.Key + "=" + next.Value), UriKind.Absolute), new SwaggerHTTPClientOptions(TimeSpan.FromSeconds(30)), token: oauthToken);
                if (response == null)
                {
                ...
                switch ((int)response.StatusCode)
                {
                    ...
                    case 200:
                    {
                        ...
                        return new APIResponse<CollectionResponseOfAdminResponse>(data, response.StatusCode);
                    }
        ...
        //</returns>
        //<param name="oauthToken"></param>
        //<param name="request">Admin information, First Name, Last Name and Email</param>
        ...
        //<summary>
        // Gets Calendar Information of the student.
        //</summary>
        //<returns>
        // Success
        //</returns>
        //<param name="oauthToken"></param>
        //<param name="request">Start &amp; End date for calendar</param>
        //<param name="id"></param>
        public async Task<APIResponse<CalendarResponse[]>> Calendar_PostStudentCalendarInformationAsync(string oauthToken, StudentCalendarInfomationRequest request, string id)
        {
            {
                var queryParameters = new Dictionary<string, object>(1);
                queryParameters.Add("id", id);
                var response = await httpClient.PostAsync(new Uri(url + "/api/calendar/user" + "?" + queryParameters.Aggregate("", (curr, next) => (curr.Length > 0 ? "?" : "") + next.Key + "=" + next.Value), UriKind.Absolute), new SwaggerHTTPClientOptions(TimeSpan.FromSeconds(30)), new StringContent(JsonConvert.SerializeObject(request)), token: oauthToken);
                if (response == null)
                {
                ...
                switch ((int)response.StatusCode)
                {
                    ...
                    case 200:
                    {
                        ...
                        return new APIResponse<CalendarResponse[]>(data, response.StatusCode);
                    }
        ...
        //<summary>
        // Creates a share calendar request.
        //</summary>
        //<returns>
        // Success
        //</returns>
        ...
        //<summary>
        // Deletes a calendar entry from a calendar.
        //</summary>
        //<returns>
        // Success
        //</returns>
        //<param name="oauthToken"></param>
        //<param name="id"></param>
        public async Task<APIResponse<object>> Calendar_DeleteCalendarEntryAsync(string oauthToken, int id)
        {
            {
                var response = await httpClient.DeleteAsync(new Uri(url + "/api/Calendar/" + id + "", UriKind.Absolute), new SwaggerHTTPClientOptions(TimeSpan.FromSeconds(30)), token: oauthToken);
                if (response == null)
                {
                    return new APIResponse<object>(false);
                }
        ...
        //<param name="skip"></param>
        //<param name="top"></param>
        public async Task<APIResponse<CollectionResponseOfCalendarResponse>> Calendar_GetCalendarAsync(string oauthToken, Nullable<int> skip, Nullable<int> top)
        {
            {
                var queryParameters = new Dictionary<string, object>(2);
                if (skip.HasValue)
                ...
                var response = await httpClient.GetAsync(new Uri(url + "/api/Calendar" + "?" + queryParameters.Aggregate("", (curr, next) => (curr.Length > 0 ? "?" : "") + next.Key + "=" + next.Value), UriKind.Absolute), new SwaggerHTTPClientOptions(TimeSpan.FromSeconds(30)), token: oauthToken);
                if (response == null)
                {
                ...
                switch ((int)response.StatusCode)
                {
                    ...
                    case 200:
                    {
                        ...
                        return new APIResponse<CollectionResponseOfCalendarResponse>(data, response.StatusCode);
                    }
        ...
        //<summary>
        // Add a student to a students list in course
        //</summary>
        //<returns>
        // Success
        //</returns>
        //<param name="oauthToken"></param>
        //<param name="request">Student ID and Course ID</param>
        public async Task<APIResponse<object>> Courses_PostAddStudentsToCourseAsync(string oauthToken, AddStudentToCourseRequest request)
        {
            {
                var response = await httpClient.PostAsync(new Uri(url + "/api/courses/addStudent", UriKind.Absolute), new SwaggerHTTPClientOptions(TimeSpan.FromSeconds(30)), new StringContent(JsonConvert.SerializeObject(request)), token: oauthToken);
                if (response == null)
                {
                    return new APIResponse<object>(false);
                }
        ...
        //<param name="skip"></param>
        //<param name="top"></param>
        public async Task<APIResponse<CollectionResponseOfCourseResponse>> Courses_GetCoursesAsync(string oauthToken, Nullable<int> skip, Nullable<int> top)
        {
            {
                var queryParameters = new Dictionary<string, object>(2);
                if (skip.HasValue)
                ...
                var response = await httpClient.GetAsync(new Uri(url + "/api/Courses" + "?" + queryParameters.Aggregate("", (curr, next) => (curr.Length > 0 ? "?" : "") + next.Key + "=" + next.Value), UriKind.Absolute), new SwaggerHTTPClientOptions(TimeSpan.FromSeconds(30)), token: oauthToken);
                if (response == null)
                {
                ...
                switch ((int)response.StatusCode)
                {
                    ...
                    case 200:
                    {
                        ...
                        return new APIResponse<CollectionResponseOfCourseResponse>(data, response.StatusCode);
                    }
        ...
        //</returns>
        //<param name="oauthToken"></param>
        //<param name="course">Course and course code</param>
        ...
        {
            {
                ...
                switch ((int)response.StatusCode)
                {
                    ...
                    case 201:
                    {
                        ...
                        return new APIResponse<CourseResponse>(data, response.StatusCode);
                    }
        ...
        //<param name="oauthToken"></param>
        //<param name="id"></param>
        //<param name="request">Couse Name and Course Code</param>
        ...
        //<param name="skip"></param>
        //<param name="top"></param>
        public async Task<APIResponse<CollectionResponseOfDroppedOutResponse>> DroppedOut_GetDroppedOutAsync(string oauthToken, Nullable<int> skip, Nullable<int> top)
        {
            {
                var queryParameters = new Dictionary<string, object>(2);
                if (skip.HasValue)
                ...
                var response = await httpClient.GetAsync(new Uri(url + "/api/DroppedOut" + "?" + queryParameters.Aggregate("", (curr, next) => (curr.Length > 0 ? "?" : "") + next.Key + "=" + next.Value), UriKind.Absolute), new SwaggerHTTPClientOptions(TimeSpan.FromSeconds(30)), token: oauthToken);
                if (response == null)
                {
                ...
                switch ((int)response.StatusCode)
                {
                    ...
                    case 200:
                    {
                        ...
                        return new APIResponse<CollectionResponseOfDroppedOutResponse>(data, response.StatusCode);
                    }
        ...
        {
            {
                ...
                switch ((int)response.StatusCode)
                {
                    ...
                    case 204:
                    {
                        ...
                        return new APIResponse<DroppedOutResponse>(data, response.StatusCode);
                    }
        ...
        //</summary>
        //<returns>
        // Student added to exam successfully
        //</returns>
        //<param name="oauthToken"></param>
        //<param name="request">Exam ID and Student ID</param>
        public async Task<APIResponse<object>> Exam_PostAddStudentToExamAsync(string oauthToken, AddStudentToExamRequest request)
        {
            {
                var response = await httpClient.PostAsync(new Uri(url + "/api/exam/addStudent", UriKind.Absolute), new SwaggerHTTPClientOptions(TimeSpan.FromSeconds(30)), new StringContent(JsonConvert.SerializeObject(request)), token: oauthToken);
                if (response == null)
                {
                    return new APIResponse<object>(false);
                }
        ...
        //<param name="skip"></param>
        //<param name="top"></param>
        public async Task<APIResponse<CollectionResponseOfExamResponse>> Exam_GetExamsAsync(string oauthToken, Nullable<int> skip, Nullable<int> top)
        {
            {
                var queryParameters = new Dictionary<string, object>(2);
                if (skip.HasValue)
                ...
                var response = await httpClient.GetAsync(new Uri(url + "/api/Exam" + "?" + queryParameters.Aggregate("", (curr, next) => (curr.Length > 0 ? "?" : "") + next.Key + "=" + next.Value), UriKind.Absolute), new SwaggerHTTPClientOptions(TimeSpan.FromSeconds(30)), token: oauthToken);
                if (response == null)
                {
                ...
                switch ((int)response.StatusCode)
                {
                    ...
                    case 200:
                    {
                        ...
                        return new APIResponse<CollectionResponseOfExamResponse>(data, response.StatusCode);
                    }
        ...
        {
            {
                ...
                switch ((int)response.StatusCode)
                {
                    ...
                    case 201:
                    {
                        ...
                        return new APIResponse<ExamResponse>(data, response.StatusCode);
                    }
        ...
        //<param name="skip"></param>
        //<param name="top"></param>
        public async Task<APIResponse<CollectionResponseOfFeedbackResponse>> Feedback_GetAllFeedbackAsync(string oauthToken, Nullable<int> skip, Nullable<int> top)
        {
            {
                var queryParameters = new Dictionary<string, object>(2);
                if (skip.HasValue)
                ...
                var response = await httpClient.GetAsync(new Uri(url + "/api/Feedback" + "?" + queryParameters.Aggregate("", (curr, next) => (curr.Length > 0 ? "?" : "") + next.Key + "=" + next.Value), UriKind.Absolute), new SwaggerHTTPClientOptions(TimeSpan.FromSeconds(30)), token: oauthToken);
                if (response == null)
                {
                ...
                switch ((int)response.StatusCode)
                {
                    ...
                    case 200:
                    {
                        ...
                        return new APIResponse<CollectionResponseOfFeedbackResponse>(data, response.StatusCode);
                    }
        ...
        {
            {
                ...
                switch ((int)response.StatusCode)
                {
                    ...
                    case 201:
                    {
                        ...
                        return new APIResponse<FeedbackResponse>(data, response.StatusCode);
                    }
        ...
        //<param name="skip"></param>
        //<param name="top"></param>
        public async Task<APIResponse<CollectionResponseOfFurtherEmploymentResponse>> FurtherEmployment_GetAllStudentsWithFurtherEmploymentAsync(string oauthToken, DateTime since, Nullable<int> skip, Nullable<int> top)
        {
            {
                ...
                var response = await httpClient.GetAsync(new Uri(url + "/api/students/furtherEmployment" + "?" + queryParameters.Aggregate("", (curr, next) => (curr.Length > 0 ? "?" : "") + next.Key + "=" + next.Value), UriKind.Absolute), new SwaggerHTTPClientOptions(TimeSpan.FromSeconds(30)), token: oauthToken);
                if (response == null)
                {
                ...
                switch ((int)response.StatusCode)
                {
                    ...
                    case 200:
                    {
                        ...
                        return new APIResponse<CollectionResponseOfFurtherEmploymentResponse>(data, response.StatusCode);
                    }
        ...
        //<param name="skip"></param>
        //<param name="top"></param>
        public async Task<APIResponse<FurtherEmploymentResponse>> FurtherEmployment_GetStudentWithFurtherEmploymentAsync(string oauthToken, string id, Nullable<int> skip, Nullable<int> top)
        {
            {
                var queryParameters = new Dictionary<string, object>(3);
                if (skip.HasValue)
                ...
                var response = await httpClient.GetAsync(new Uri(url + "/api/students/" + id + "/furtherEmployment" + "?" + queryParameters.Aggregate("", (curr, next) => (curr.Length > 0 ? "?" : "") + next.Key + "=" + next.Value), UriKind.Absolute), new SwaggerHTTPClientOptions(TimeSpan.FromSeconds(30)), token: oauthToken);
                if (response == null)
                {
                ...
                switch ((int)response.StatusCode)
                {
                    ...
                    case 200:
                    {
                        ...
                        return new APIResponse<FurtherEmploymentResponse>(data, response.StatusCode);
                    }
        ...
        //<param name="hostEmployerId"></param>
        public async Task<APIResponse<object>> HostEmployer_PostAssociateStudentToHostEmployeerAsync(string oauthToken, string studentId, int hostEmployerId)
        {
            {
                var queryParameters = new Dictionary<string, object>(1);
                queryParameters.Add("hostEmployerId", hostEmployerId);
                var response = await httpClient.PostAsync(new Uri(url + "/api/students/hostEmployer" + "?" + queryParameters.Aggregate("", (curr, next) => (curr.Length > 0 ? "?" : "") + next.Key + "=" + next.Value), UriKind.Absolute), new SwaggerHTTPClientOptions(TimeSpan.FromSeconds(30)), new StringContent(JsonConvert.SerializeObject(studentId)), token: oauthToken);
                if (response == null)
                {
                    return new APIResponse<object>(false);
                }
        ...
        //<param name="skip"></param>
        //<param name="top"></param>
        public async Task<APIResponse<HostEmployerResponse>> HostEmployer_GetHostEmployerAsync(string oauthToken, int id, Nullable<int> skip, Nullable<int> top)
        {
            {
                var queryParameters = new Dictionary<string, object>(3);
                if (skip.HasValue)
                ...
                var response = await httpClient.GetAsync(new Uri(url + "/api/HostEmployer/" + id + "" + "?" + queryParameters.Aggregate("", (curr, next) => (curr.Length > 0 ? "?" : "") + next.Key + "=" + next.Value), UriKind.Absolute), new SwaggerHTTPClientOptions(TimeSpan.FromSeconds(30)), token: oauthToken);
                if (response == null)
                {
                ...
                switch ((int)response.StatusCode)
                {
                    ...
                    case 200:
                    {
                        ...
                        return new APIResponse<HostEmployerResponse>(data, response.StatusCode);
                    }
        ...
        //<param name="oauthToken"></param>
        //<param name="id"></param>
        //<param name="request">Host Employer Name</param>
        public async Task<APIResponse<object>> HostEmployer_PutHostEmployerAsync(string oauthToken, int id, HostEmployerRequest request)
        {
            {
        ...
        //<param name="skip"></param>
        //<param name="top"></param>
        public async Task<APIResponse<CollectionResponseOfHostEmployerResponse>> HostEmployer_GetHostEmployersAsync(string oauthToken, Nullable<int> skip, Nullable<int> top)
        {
            {
                var queryParameters = new Dictionary<string, object>(2);
                if (skip.HasValue)
                ...
                var response = await httpClient.GetAsync(new Uri(url + "/api/HostEmployer" + "?" + queryParameters.Aggregate("", (curr, next) => (curr.Length > 0 ? "?" : "") + next.Key + "=" + next.Value), UriKind.Absolute), new SwaggerHTTPClientOptions(TimeSpan.FromSeconds(30)), token: oauthToken);
                if (response == null)
                {
                ...
                switch ((int)response.StatusCode)
                {
                    ...
                    case 200:
                    {
                        ...
                        return new APIResponse<CollectionResponseOfHostEmployerResponse>(data, response.StatusCode);
                    }
        ...
        //</returns>
        //<param name="oauthToken"></param>
        //<param name="hostEmployer">Host Employer Name</param>
        ...
        {
            {
                ...
                switch ((int)response.StatusCode)
                {
                    ...
                    case 201:
                    {
                        ...
                        return new APIResponse<StudentResponse>(data, response.StatusCode);
                    }
        ...
        //<summary>
        // Gets all the student claimed rewards from the system.
        //</summary>
        //<returns>
        // Success
        //</returns>
        ...
        //<param name="skip"></param>
        //<param name="top"></param>
        public async Task<APIResponse<CollectionResponseOfClaimedRewardsResponse>> Reward_GetStudentRewardAsync(string oauthToken, string userId, DateTime date, Nullable<int> skip, Nullable<int> top)
        {
            {
                ...
                var response = await httpClient.GetAsync(new Uri(url + "/api/students/" + userId + "/reward" + "?" + queryParameters.Aggregate("", (curr, next) => (curr.Length > 0 ? "?" : "") + next.Key + "=" + next.Value), UriKind.Absolute), new SwaggerHTTPClientOptions(TimeSpan.FromSeconds(30)), token: oauthToken);
                if (response == null)
                {
                ...
                switch ((int)response.StatusCode)
                {
                    ...
                    case 200:
                    {
                        ...
                        return new APIResponse<CollectionResponseOfClaimedRewardsResponse>(data, response.StatusCode);
                    }
        ...
        public async Task<APIResponse<object>> Reward_PostAssociateStudentToRewardAsync(string oauthToken, string studentId, int rewardsId)
        {
            {
                var queryParameters = new Dictionary<string, object>(1);
                queryParameters.Add("rewardsId", rewardsId);
                var response = await httpClient.PostAsync(new Uri(url + "/api/students/rewards" + "?" + queryParameters.Aggregate("", (curr, next) => (curr.Length > 0 ? "?" : "") + next.Key + "=" + next.Value), UriKind.Absolute), new SwaggerHTTPClientOptions(TimeSpan.FromSeconds(30)), new StringContent(JsonConvert.SerializeObject(studentId)), token: oauthToken);
                if (response == null)
                {
                    return new APIResponse<object>(false);
                }
        ...
        //<summary>
        // Students can claim rewards and icon rewards.
        //</summary>
        //<returns>
        // Success
        //</returns>
        //<param name="oauthToken"></param>
        //<param name="id"></param>
        public async Task<APIResponse<RewardResponse>> Reward_GetRewardsAsync(string oauthToken, int id)
        {
            {
                ...
                switch ((int)response.StatusCode)
                {
                    ...
                    case 200:
                    {
                        ...
                        return new APIResponse<RewardResponse>(data, response.StatusCode);
                    }
        ...
        //<summary>
        // Associates a student with a reward.
        //</summary>
        //<returns>
        // success
        //</returns>
        ...
        public async Task<APIResponse<object>> Reward_SetRewardStateAsync(string oauthToken, int id, string requiredState, string requestedState)
        {
            {
                var queryParameters = new Dictionary<string, object>(3);
                queryParameters.Add("requiredState", requiredState);
                queryParameters.Add("requestedState", requestedState);
                var response = await httpClient.PostAsync(new Uri(url + "/api/Reward/" + id + "" + "?" + queryParameters.Aggregate("", (curr, next) => (curr.Length > 0 ? "?" : "") + next.Key + "=" + next.Value), UriKind.Absolute), new SwaggerHTTPClientOptions(TimeSpan.FromSeconds(30)), token: oauthToken);
                if (response == null)
                {
                    return new APIResponse<object>(false);
                }
        ...
        //<param name="oauthToken"></param>
        //<param name="id"></param>
        //<param name="request">Reward Details</param>
        ...
        //<param name="skip"></param>
        //<param name="top"></param>
        public async Task<APIResponse<CollectionResponseOfRewardResponse>> Reward_GetRewardsAsync(string oauthToken, Nullable<int> skip, Nullable<int> top)
        {
            {
                var queryParameters = new Dictionary<string, object>(2);
                if (skip.HasValue)
                ...
                var response = await httpClient.GetAsync(new Uri(url + "/api/Reward" + "?" + queryParameters.Aggregate("", (curr, next) => (curr.Length > 0 ? "?" : "") + next.Key + "=" + next.Value), UriKind.Absolute), new SwaggerHTTPClientOptions(TimeSpan.FromSeconds(30)), token: oauthToken);
                if (response == null)
                {
                ...
                switch ((int)response.StatusCode)
                {
                    ...
                    case 200:
                    {
                        ...
                        return new APIResponse<CollectionResponseOfRewardResponse>(data, response.StatusCode);
                    }
        ...
        //<summary>
        // Gets the share Calendar using the Id and start Date.
        //</summary>
        //<returns>
        // Success
        //</returns>
        ...
        //<param name="skip"></param>
        //<param name="top"></param>
        public async Task<APIResponse<CollectionResponseOfCalendarResponse>> ShareCalendar_GetShareCalendarAsync(string id, DateTime startDate, Nullable<int> skip, Nullable<int> top)
        {
            {
                var queryParameters = new Dictionary<string, object>(4);
                if (skip.HasValue)
                ...
                var response = await httpClient.GetAsync(new Uri(url + "/api/ShareCalendar/" + id + "/" + startDate + "" + "?" + queryParameters.Aggregate("", (curr, next) => (curr.Length > 0 ? "?" : "") + next.Key + "=" + next.Value), UriKind.Absolute), new SwaggerHTTPClientOptions(TimeSpan.FromSeconds(30)));
                if (response == null)
                {
                    return new APIResponse<CollectionResponseOfCalendarResponse>(false);
                }
        ...
        //<param name="skip"></param>
        //<param name="top"></param>
        public async Task<APIResponse<CollectionResponseOfClaimedRewardsResponse>> Students_GetStudentRewardsAsync(string oauthToken, string id, Nullable<int> skip, Nullable<int> top)
        {
            {
                var queryParameters = new Dictionary<string, object>(3);
                if (skip.HasValue)
                ...
                var response = await httpClient.GetAsync(new Uri(url + "/api/students/" + id + "/rewards" + "?" + queryParameters.Aggregate("", (curr, next) => (curr.Length > 0 ? "?" : "") + next.Key + "=" + next.Value), UriKind.Absolute), new SwaggerHTTPClientOptions(TimeSpan.FromSeconds(30)), token: oauthToken);
                if (response == null)
                {
                    return new APIResponse<CollectionResponseOfClaimedRewardsResponse>(false);
                }
        ...
        {
            {
                ...
                switch ((int)response.StatusCode)
                {
                    ...
                    case 200:
                    {
                        ...
                        return new APIResponse<CollectionResponseOfTrainingProviderResponse>(data, response.StatusCode);
                    }
        ...
        //<summary>
        // Students add personal information.
        //</summary>
        //<returns>
        // Success
        //</returns>
        //<param name="oauthToken"></param>
        //<param name="id"></param>
        //<param name="student">Users details</param>
        public async Task<APIResponse<StudentResponse>> Students_PostStudentInformationAsync(string oauthToken, string id, StudentsRequest student)
        {
            {
                var queryParameters = new Dictionary<string, object>(1);
                queryParameters.Add("id", id);
                var response = await httpClient.PostAsync(new Uri(url + "/api/students/information" + "?" + queryParameters.Aggregate("", (curr, next) => (curr.Length > 0 ? "?" : "") + next.Key + "=" + next.Value), UriKind.Absolute), new SwaggerHTTPClientOptions(TimeSpan.FromSeconds(30)), new StringContent(JsonConvert.SerializeObject(student)), token: oauthToken);
                if (response == null)
                {
                    return new APIResponse<StudentResponse>(false);
                }
        ...
        //<summary>
        // Gets all students from the system for administators.
        //</summary>
        //<returns>
        // Success
        //</returns>
        ...
        //<param name="skip"></param>
        //<param name="top"></param>
        public async Task<APIResponse<CollectionResponseOfStudentResponse>> Students_GetStudentsAsync(string oauthToken, Nullable<int> skip, Nullable<int> top)
        {
            {
                var queryParameters = new Dictionary<string, object>(2);
                if (skip.HasValue)
                ...
                var response = await httpClient.GetAsync(new Uri(url + "/api/Students" + "?" + queryParameters.Aggregate("", (curr, next) => (curr.Length > 0 ? "?" : "") + next.Key + "=" + next.Value), UriKind.Absolute), new SwaggerHTTPClientOptions(TimeSpan.FromSeconds(30)), token: oauthToken);
                if (response == null)
                {
                ...
                switch ((int)response.StatusCode)
                {
                    ...
                    case 200:
                    {
                        ...
                        return new APIResponse<CollectionResponseOfStudentResponse>(data, response.StatusCode);
                    }
        ...
        //</returns>
        //<param name="oauthToken"></param>
        //<param name="request">Training Provider Name</param>
        ...
        //<summary>
        // Associates a student to a training Provider
        //</summary>
        //<returns>
        // Success
        //</returns>
        ...
        public async Task<APIResponse<object>> TrainingProviders_PostAssociateStudentToTrainingProviderAsync(string oauthToken, string studentId, int trainingProviderId)
        {
            {
                var queryParameters = new Dictionary<string, object>(1);
                queryParameters.Add("trainingProviderId", trainingProviderId);
                var response = await httpClient.PostAsync(new Uri(url + "/api/students/trainingProviders" + "?" + queryParameters.Aggregate("", (curr, next) => (curr.Length > 0 ? "?" : "") + next.Key + "=" + next.Value), UriKind.Absolute), new SwaggerHTTPClientOptions(TimeSpan.FromSeconds(30)), new StringContent(JsonConvert.SerializeObject(studentId)), token: oauthToken);
                if (response == null)
                {
                    return new APIResponse<object>(false);
                }
        ...
        //<summary>
        // Enables a TrainingProvider from the system
        //</summary>
        //<returns>
        // Success
        //</returns>
        //<param name="oauthToken"></param>
        //<param name="id"></param>
        public async Task<APIResponse<object>> TrainingProviders_PutEnableTrainingProviderAsync(string oauthToken, int id)
        {
            {
                var response = await httpClient.PutAsync(new Uri(url + "/api/trainingproviders/" + id + "/enable", UriKind.Absolute), new SwaggerHTTPClientOptions(TimeSpan.FromSeconds(30)), token: oauthToken);
                if (response == null)
                {
                    return new APIResponse<object>(false);
                }
        ...
        //<param name="skip"></param>
        //<param name="top"></param>
        public async Task<APIResponse<TrainingProviderResponse>> TrainingProviders_GetTrainingProviderAsync(string oauthToken, int id, Nullable<int> skip, Nullable<int> top)
        {
            {
                var queryParameters = new Dictionary<string, object>(3);
                if (skip.HasValue)
                ...
                var response = await httpClient.GetAsync(new Uri(url + "/api/TrainingProviders/" + id + "" + "?" + queryParameters.Aggregate("", (curr, next) => (curr.Length > 0 ? "?" : "") + next.Key + "=" + next.Value), UriKind.Absolute), new SwaggerHTTPClientOptions(TimeSpan.FromSeconds(30)), token: oauthToken);
                if (response == null)
                {
                ...
                switch ((int)response.StatusCode)
                {
                    ...
                    case 200:
                    {
                        ...
                        return new APIResponse<TrainingProviderResponse>(data, response.StatusCode);
                    }
        ...
        //<param name="id"></param>
        //<param name="request">Training Provider Name</param>
        public async Task<APIResponse<object>> TrainingProviders_PutTrainingProvidersAsync(string oauthToken, int id, TrainingProviderRequest request)
        {
            {
        ...
        //<param name="skip"></param>
        //<param name="top"></param>
        public async Task<APIResponse<CollectionResponseOfTrainingProviderResponse>> TrainingProviders_GetTrainingProvidersAsync(string oauthToken, Nullable<int> skip, Nullable<int> top)
        {
            {
                var queryParameters = new Dictionary<string, object>(2);
                if (skip.HasValue)
                ...
                var response = await httpClient.GetAsync(new Uri(url + "/api/TrainingProviders" + "?" + queryParameters.Aggregate("", (curr, next) => (curr.Length > 0 ? "?" : "") + next.Key + "=" + next.Value), UriKind.Absolute), new SwaggerHTTPClientOptions(TimeSpan.FromSeconds(30)), token: oauthToken);
                if (response == null)
                {
                    return new APIResponse<CollectionResponseOfTrainingProviderResponse>(false);
                }
        ...
        //</returns>
        //<param name="oauthToken"></param>
        //<param name="trainingProvider">Training Provider Name</param>
        ...
        //</returns>
        //<param name="oauthToken"></param>
        //<param name="courseRequest">Course update information</param>
