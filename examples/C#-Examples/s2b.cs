...
// This file was last generated at: 2016-03-30T11:19:08.8853820Z
namespace nSwagger
{
    ...
    public class Portal
    {
        ...
        {
            {
                var response = await httpClient.PostAsync(new Uri(url + "/api/calendar/user", UriKind.Absolute), new SwaggerHTTPClientOptions(TimeSpan.FromSeconds(30)), new StringContent(JsonConvert.SerializeObject(request)), token: oauthToken);
                if (response == null)
                {
        ...
        {
            {
                var response = await httpClient.PostAsync(new Uri(url + "/api/students/hostEmployer", UriKind.Absolute), new SwaggerHTTPClientOptions(TimeSpan.FromSeconds(30)), new StringContent(JsonConvert.SerializeObject(studentId)), token: oauthToken);
                if (response == null)
                {
                    return new APIResponse<object>(false);
                }
        ...
        //<param name="skip"></param>
        //<param name="top"></param>
        public async Task<APIResponse<CollectionResponseOfClaimedRewardsResponse>> Reward_GetStudentRewardAsync(string oauthToken, string userId, DateTime date, int skip, int top)
        {
            {
                var response = await httpClient.GetAsync(new Uri(url + "/api/students/" + userId + "/reward", UriKind.Absolute), new SwaggerHTTPClientOptions(TimeSpan.FromSeconds(30)), token: oauthToken);
                if (response == null)
                {
        ...
        {
            {
                var response = await httpClient.PostAsync(new Uri(url + "/api/students/rewards", UriKind.Absolute), new SwaggerHTTPClientOptions(TimeSpan.FromSeconds(30)), new StringContent(JsonConvert.SerializeObject(studentId)), token: oauthToken);
                if (response == null)
                {
                    return new APIResponse<object>(false);
                }
        ...
        //<param name="skip"></param>
        //<param name="top"></param>
        public async Task<APIResponse<CollectionResponseOfRewardResponse>> Reward_GetRewardsAsync(string oauthToken, int skip, int top)
        {
            {
        ...
        //<param name="skip"></param>
        //<param name="top"></param>
        public async Task<APIResponse<CollectionResponseOfCalendarResponse>> ShareCalendar_GetShareCalendarAsync(string id, DateTime startDate, int skip, int top)
        {
            {
                var response = await httpClient.GetAsync(new Uri(url + "/api/ShareCalendar/" + id + "/" + startDate + "", UriKind.Absolute), new SwaggerHTTPClientOptions(TimeSpan.FromSeconds(30)));
                if (response == null)
                {
                    return new APIResponse<CollectionResponseOfCalendarResponse>(false);
                }
        ...
        {
            {
                var response = await httpClient.PostAsync(new Uri(url + "/api/students/information", UriKind.Absolute), new SwaggerHTTPClientOptions(TimeSpan.FromSeconds(30)), new StringContent(JsonConvert.SerializeObject(student)), token: oauthToken);
                if (response == null)
                {
                    return new APIResponse<StudentResponse>(false);
                }
        ...
        {
            {
                var response = await httpClient.PostAsync(new Uri(url + "/api/students/trainingProviders", UriKind.Absolute), new SwaggerHTTPClientOptions(TimeSpan.FromSeconds(30)), new StringContent(JsonConvert.SerializeObject(studentId)), token: oauthToken);
                if (response == null)
                {
                    return new APIResponse<object>(false);
                }
